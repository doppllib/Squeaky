...
- (id<JavaUtilList>)getTokenList {
  OrgApacheCommonsLang3TextStrTokenizer_checkTokenized(self);
  id<JavaUtilList> list = create_JavaUtilArrayList_initWithInt_(((IOSObjectArray *) nil_chk(tokens_))->size_);
  {
...
- (OrgApacheCommonsLang3TextStrTokenizer *)resetWithNSString:(NSString *)input {
  [self reset];
  if (input != nil) {
    JreStrongAssign(&self->chars_, [input java_toCharArray]);
  }
  else {
    JreStrongAssign(&self->chars_, nil);
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrTokenizer *)resetWithCharArray:(IOSCharArray *)input {
  [self reset];
  JreStrongAssign(&self->chars_, OrgApacheCommonsLang3ArrayUtils_cloneWithCharArray_(input));
  return self;
}
...
- (void)remove {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"remove() is unsupported");
}

- (void)setWithId:(NSString *)obj {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"set() is unsupported");
}

- (void)addWithId:(NSString *)obj {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"add() is unsupported");
}
...
- (id<JavaUtilList>)tokenizeWithCharArray:(IOSCharArray *)srcChars
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = create_OrgApacheCommonsLang3TextStrBuilder_init();
  id<JavaUtilList> tokenList = create_JavaUtilArrayList_init();
  jint pos = offset;
  while (pos >= 0 && pos < count) {
    ...
    if (pos >= count) {
      OrgApacheCommonsLang3TextStrTokenizer_addTokenWithJavaUtilList_withNSString_(self, tokenList, OrgApacheCommonsLang3StringUtils_EMPTY);
    }
  }
  return tokenList;
}
...
- (OrgApacheCommonsLang3TextStrTokenizer *)setDelimiterMatcherWithOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)delim {
  if (delim == nil) {
    JreStrongAssign(&self->delimMatcher_, OrgApacheCommonsLang3TextStrMatcher_noneMatcher());
  }
  else {
    JreStrongAssign(&self->delimMatcher_, delim);
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrTokenizer *)setQuoteMatcherWithOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)quote {
  if (quote != nil) {
    JreStrongAssign(&self->quoteMatcher_, quote);
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrTokenizer *)setIgnoredMatcherWithOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)ignored {
  if (ignored != nil) {
    JreStrongAssign(&self->ignoredMatcher_, ignored);
  }
  return self;
}
...
- (OrgApacheCommonsLang3TextStrTokenizer *)setTrimmerMatcherWithOrgApacheCommonsLang3TextStrMatcher:(OrgApacheCommonsLang3TextStrMatcher *)trimmer {
  if (trimmer != nil) {
    JreStrongAssign(&self->trimmerMatcher_, trimmer);
  }
  return self;
}
...
- (id)cloneReset {
  ...
  if (((OrgApacheCommonsLang3TextStrTokenizer *) nil_chk(cloned))->chars_ != nil) {
    JreStrongAssign(&cloned->chars_, [cloned->chars_ java_clone]);
  }
  [cloned reset];
  return cloned;
}
...
- (void)dealloc {
  RELEASE_(chars_);
  RELEASE_(tokens_);
  RELEASE_(delimMatcher_);
  RELEASE_(quoteMatcher_);
  RELEASE_(ignoredMatcher_);
  RELEASE_(trimmerMatcher_);
  [super dealloc];
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TextStrTokenizer class]) {
    {
      JreStrongAssignAndConsume(&OrgApacheCommonsLang3TextStrTokenizer_CSV_TOKENIZER_PROTOTYPE, new_OrgApacheCommonsLang3TextStrTokenizer_init());
      [OrgApacheCommonsLang3TextStrTokenizer_CSV_TOKENIZER_PROTOTYPE setDelimiterMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrMatcher_commaMatcher()];
      [OrgApacheCommonsLang3TextStrTokenizer_CSV_TOKENIZER_PROTOTYPE setQuoteMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrMatcher_doubleQuoteMatcher()];
      [OrgApacheCommonsLang3TextStrTokenizer_CSV_TOKENIZER_PROTOTYPE setIgnoredMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrMatcher_noneMatcher()];
      [OrgApacheCommonsLang3TextStrTokenizer_CSV_TOKENIZER_PROTOTYPE setTrimmerMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrMatcher_trimMatcher()];
      [OrgApacheCommonsLang3TextStrTokenizer_CSV_TOKENIZER_PROTOTYPE setEmptyTokenAsNullWithBoolean:false];
      [OrgApacheCommonsLang3TextStrTokenizer_CSV_TOKENIZER_PROTOTYPE setIgnoreEmptyTokensWithBoolean:false];
      JreStrongAssignAndConsume(&OrgApacheCommonsLang3TextStrTokenizer_TSV_TOKENIZER_PROTOTYPE, new_OrgApacheCommonsLang3TextStrTokenizer_init());
      [OrgApacheCommonsLang3TextStrTokenizer_TSV_TOKENIZER_PROTOTYPE setDelimiterMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrMatcher_tabMatcher()];
      [OrgApacheCommonsLang3TextStrTokenizer_TSV_TOKENIZER_PROTOTYPE setQuoteMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrMatcher_doubleQuoteMatcher()];
      [OrgApacheCommonsLang3TextStrTokenizer_TSV_TOKENIZER_PROTOTYPE setIgnoredMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrMatcher_noneMatcher()];
      [OrgApacheCommonsLang3TextStrTokenizer_TSV_TOKENIZER_PROTOTYPE setTrimmerMatcherWithOrgApacheCommonsLang3TextStrMatcher:OrgApacheCommonsLang3TextStrMatcher_trimMatcher()];
      [OrgApacheCommonsLang3TextStrTokenizer_TSV_TOKENIZER_PROTOTYPE setEmptyTokenAsNullWithBoolean:false];
      [OrgApacheCommonsLang3TextStrTokenizer_TSV_TOKENIZER_PROTOTYPE setIgnoreEmptyTokensWithBoolean:false];
    }
...
OrgApacheCommonsLang3TextStrTokenizer *OrgApacheCommonsLang3TextStrTokenizer_getCSVInstanceWithNSString_(NSString *input) {
  ...
  [((OrgApacheCommonsLang3TextStrTokenizer *) nil_chk(tok)) resetWithNSString:input];
  return tok;
}
...
OrgApacheCommonsLang3TextStrTokenizer *OrgApacheCommonsLang3TextStrTokenizer_getCSVInstanceWithCharArray_(IOSCharArray *input) {
  OrgApacheCommonsLang3TextStrTokenizer_initialize();
  OrgApacheCommonsLang3TextStrTokenizer *tok = OrgApacheCommonsLang3TextStrTokenizer_getCSVClone();
  [((OrgApacheCommonsLang3TextStrTokenizer *) nil_chk(tok)) resetWithCharArray:input];
  return tok;
}
...
void OrgApacheCommonsLang3TextStrTokenizer_init(OrgApacheCommonsLang3TextStrTokenizer *self) {
  NSObject_init(self);
  JreStrongAssign(&self->delimMatcher_, OrgApacheCommonsLang3TextStrMatcher_splitMatcher());
  JreStrongAssign(&self->quoteMatcher_, OrgApacheCommonsLang3TextStrMatcher_noneMatcher());
  JreStrongAssign(&self->ignoredMatcher_, OrgApacheCommonsLang3TextStrMatcher_noneMatcher());
  JreStrongAssign(&self->trimmerMatcher_, OrgApacheCommonsLang3TextStrMatcher_noneMatcher());
...
void OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_withChar_(OrgApacheCommonsLang3TextStrTokenizer *self, NSString *input, jchar delim) {
  OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_(self, input);
  [self setDelimiterCharWithChar:delim];
}
...
void OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_withNSString_(OrgApacheCommonsLang3TextStrTokenizer *self, NSString *input, NSString *delim) {
  OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_(self, input);
  [self setDelimiterStringWithNSString:delim];
}
...
void OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_withOrgApacheCommonsLang3TextStrMatcher_(OrgApacheCommonsLang3TextStrTokenizer *self, NSString *input, OrgApacheCommonsLang3TextStrMatcher *delim) {
  OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_(self, input);
  [self setDelimiterMatcherWithOrgApacheCommonsLang3TextStrMatcher:delim];
}
...
void OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_withChar_withChar_(OrgApacheCommonsLang3TextStrTokenizer *self, NSString *input, jchar delim, jchar quote) {
  OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_withChar_(self, input, delim);
  [self setQuoteCharWithChar:quote];
}
...
void OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_withOrgApacheCommonsLang3TextStrMatcher_withOrgApacheCommonsLang3TextStrMatcher_(OrgApacheCommonsLang3TextStrTokenizer *self, NSString *input, OrgApacheCommonsLang3TextStrMatcher *delim, OrgApacheCommonsLang3TextStrMatcher *quote) {
  OrgApacheCommonsLang3TextStrTokenizer_initWithNSString_withOrgApacheCommonsLang3TextStrMatcher_(self, input, delim);
  [self setQuoteMatcherWithOrgApacheCommonsLang3TextStrMatcher:quote];
}
...
void OrgApacheCommonsLang3TextStrTokenizer_checkTokenized(OrgApacheCommonsLang3TextStrTokenizer *self) {
  if (self->tokens_ == nil) {
    if (self->chars_ == nil) {
      ...
      JreStrongAssign(&self->tokens_, [((id<JavaUtilList>) nil_chk(split)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[split size] type:NSString_class_()]]);
    }
    else {
...
jint OrgApacheCommonsLang3TextStrTokenizer_readWithQuotesWithCharArray_withInt_withInt_withOrgApacheCommonsLang3TextStrBuilder_withJavaUtilList_withInt_withInt_(OrgApacheCommonsLang3TextStrTokenizer *self, IOSCharArray *srcChars, jint start, jint len, OrgApacheCommonsLang3TextStrBuilder *workArea, id<JavaUtilList> tokenList, jint quoteStart, jint quoteLen) {
  [((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(workArea)) clear];
  jint pos = start;
    ...
    if (quoting) {
      if (OrgApacheCommonsLang3TextStrTokenizer_isQuoteWithCharArray_withInt_withInt_withInt_withInt_(self, srcChars, pos, len, quoteStart, quoteLen)) {
        if (OrgApacheCommonsLang3TextStrTokenizer_isQuoteWithCharArray_withInt_withInt_withInt_withInt_(self, srcChars, pos + quoteLen, len, quoteStart, quoteLen)) {
          [workArea appendWithCharArray:srcChars withInt:pos withInt:quoteLen];
          pos += quoteLen * 2;
      ...
      [workArea appendWithChar:IOSCharArray_Get(nil_chk(srcChars), pos++)];
      trimStart = [workArea size];
    }
    else {
      ...
      if (trimmedLen > 0) {
        [workArea appendWithCharArray:srcChars withInt:pos withInt:trimmedLen];
        pos += trimmedLen;
        continue;
      }
      [workArea appendWithChar:IOSCharArray_Get(nil_chk(srcChars), pos++)];
