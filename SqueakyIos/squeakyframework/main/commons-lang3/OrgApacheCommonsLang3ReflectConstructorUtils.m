...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/reflect/ConstructorUtils.java
//
...
#include "OrgApacheCommonsLang3ReflectConstructorUtils.h"
...
id OrgApacheCommonsLang3ReflectConstructorUtils_invokeConstructorWithIOSClass_withNSObjectArray_withIOSClassArray_(IOSClass *cls, IOSObjectArray *args, IOSObjectArray *parameterTypes) {
  ...
  if (ctor == nil) {
    @throw create_JavaLangNoSuchMethodException_initWithNSString_(JreStrcat("$$", @"No such accessible constructor on object: ", [((IOSClass *) nil_chk(cls)) getName]));
  }
  if ([ctor isVarArgs]) {
    IOSObjectArray *methodParameterTypes = [ctor getParameterTypes];
...
JavaLangReflectConstructor *OrgApacheCommonsLang3ReflectConstructorUtils_getAccessibleConstructorWithIOSClass_withIOSClassArray_(IOSClass *cls, IOSObjectArray *parameterTypes) {
  OrgApacheCommonsLang3ReflectConstructorUtils_initialize();
  OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(cls, @"class cannot be null", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  @try {
...
JavaLangReflectConstructor *OrgApacheCommonsLang3ReflectConstructorUtils_getAccessibleConstructorWithJavaLangReflectConstructor_(JavaLangReflectConstructor *ctor) {
  OrgApacheCommonsLang3ReflectConstructorUtils_initialize();
  OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(ctor, @"constructor cannot be null", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
...
JavaLangReflectConstructor *OrgApacheCommonsLang3ReflectConstructorUtils_getMatchingAccessibleConstructorWithIOSClass_withIOSClassArray_(IOSClass *cls, IOSObjectArray *parameterTypes) {
  ...
  IOSObjectArray *ctors = [cls getConstructors];
  {
    ...
    while (b__ < e__) {
      ...
      if (OrgApacheCommonsLang3ReflectMemberUtils_isMatchingConstructorWithJavaLangReflectConstructor_withIOSClassArray_(ctor, parameterTypes)) {
        ctor = OrgApacheCommonsLang3ReflectConstructorUtils_getAccessibleConstructorWithJavaLangReflectConstructor_(ctor);
        if (ctor != nil) {
          OrgApacheCommonsLang3ReflectMemberUtils_setAccessibleWorkaroundWithJavaLangReflectAccessibleObject_(ctor);
          if (result == nil || OrgApacheCommonsLang3ReflectMemberUtils_compareConstructorFitWithJavaLangReflectConstructor_withJavaLangReflectConstructor_withIOSClassArray_(ctor, result, parameterTypes) < 0) {
