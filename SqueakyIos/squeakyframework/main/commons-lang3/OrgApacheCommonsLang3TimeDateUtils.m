...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/time/DateUtils.java
//
...
#include "OrgApacheCommonsLang3TimeDateUtils.h"
...
+ (JavaUtilCalendar *)toCalendarWithJavaUtilDate:(JavaUtilDate *)date
  ...
  return OrgApacheCommonsLang3TimeDateUtils_toCalendarWithJavaUtilDate_withJavaUtilTimeZone_(date, tz);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LJavaUtilCalendar;", 0x9, 31, 33, -1, -1, -1, -1 },
    { NULL, "LJavaUtilDate;", 0x9, 34, 13, -1, -1, -1, -1 },
    { NULL, "LJavaUtilCalendar;", 0x9, 34, 35, -1, -1, -1, -1 },
    { NULL, "LJavaUtilDate;", 0x9, 34, 36, -1, -1, -1, -1 },
    { NULL, "LJavaUtilDate;", 0x9, 37, 13, -1, -1, -1, -1 },
    { NULL, "LJavaUtilCalendar;", 0x9, 37, 35, -1, -1, -1, -1 },
    { NULL, "LJavaUtilDate;", 0x9, 37, 36, -1, -1, -1, -1 },
    { NULL, "LJavaUtilDate;", 0x9, 38, 13, -1, -1, -1, -1 },
    { NULL, "LJavaUtilCalendar;", 0x9, 38, 35, -1, -1, -1, -1 },
    { NULL, "LJavaUtilDate;", 0x9, 38, 36, -1, -1, -1, -1 },
    { NULL, "V", 0xa, 39, 40, -1, -1, -1, -1 },
    { NULL, "LJavaUtilIterator;", 0x9, 41, 13, -1, 42, -1, -1 },
    { NULL, "LJavaUtilIterator;", 0x9, 41, 35, -1, 43, -1, -1 },
    { NULL, "LJavaUtilIterator;", 0x9, 41, 36, -1, 44, -1, -1 },
    { NULL, "J", 0x9, 45, 13, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 46, 13, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 47, 13, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 48, 13, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 49, 13, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 45, 35, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 46, 35, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 47, 35, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 48, 35, -1, -1, -1, -1 },
    { NULL, "J", 0x9, 49, 35, -1, -1, -1, -1 },
    { NULL, "J", 0xa, 50, 51, -1, -1, -1, -1 },
    { NULL, "J", 0xa, 50, 52, -1, -1, -1, -1 },
    { NULL, "Z", 0x9, 53, 54, -1, -1, -1, -1 },
    { NULL, "Z", 0x9, 53, 55, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 56, 54, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 56, 55, -1, -1, -1, -1 },
  };
  ...
  methods[29].selector = @selector(toCalendarWithJavaUtilDate:withJavaUtilTimeZone:);
  methods[30].selector = @selector(roundWithJavaUtilDate:withInt:);
  methods[31].selector = @selector(roundWithJavaUtilCalendar:withInt:);
  methods[32].selector = @selector(roundWithId:withInt:);
  methods[33].selector = @selector(truncateWithJavaUtilDate:withInt:);
  methods[34].selector = @selector(truncateWithJavaUtilCalendar:withInt:);
  methods[35].selector = @selector(truncateWithId:withInt:);
  methods[36].selector = @selector(ceilingWithJavaUtilDate:withInt:);
  methods[37].selector = @selector(ceilingWithJavaUtilCalendar:withInt:);
  methods[38].selector = @selector(ceilingWithId:withInt:);
  methods[39].selector = @selector(modifyWithJavaUtilCalendar:withInt:withOrgApacheCommonsLang3TimeDateUtils_ModifyType:);
  methods[40].selector = @selector(iteratorWithJavaUtilDate:withInt:);
  methods[41].selector = @selector(iteratorWithJavaUtilCalendar:withInt:);
  methods[42].selector = @selector(iteratorWithId:withInt:);
  methods[43].selector = @selector(getFragmentInMillisecondsWithJavaUtilDate:withInt:);
  methods[44].selector = @selector(getFragmentInSecondsWithJavaUtilDate:withInt:);
  methods[45].selector = @selector(getFragmentInMinutesWithJavaUtilDate:withInt:);
  methods[46].selector = @selector(getFragmentInHoursWithJavaUtilDate:withInt:);
  methods[47].selector = @selector(getFragmentInDaysWithJavaUtilDate:withInt:);
  methods[48].selector = @selector(getFragmentInMillisecondsWithJavaUtilCalendar:withInt:);
  methods[49].selector = @selector(getFragmentInSecondsWithJavaUtilCalendar:withInt:);
  methods[50].selector = @selector(getFragmentInMinutesWithJavaUtilCalendar:withInt:);
  methods[51].selector = @selector(getFragmentInHoursWithJavaUtilCalendar:withInt:);
  methods[52].selector = @selector(getFragmentInDaysWithJavaUtilCalendar:withInt:);
  methods[53].selector = @selector(getFragmentWithJavaUtilDate:withInt:withJavaUtilConcurrentTimeUnit:);
  methods[54].selector = @selector(getFragmentWithJavaUtilCalendar:withInt:withJavaUtilConcurrentTimeUnit:);
  methods[55].selector = @selector(truncatedEqualsWithJavaUtilCalendar:withJavaUtilCalendar:withInt:);
  methods[56].selector = @selector(truncatedEqualsWithJavaUtilDate:withJavaUtilDate:withInt:);
  methods[57].selector = @selector(truncatedCompareToWithJavaUtilCalendar:withJavaUtilCalendar:withInt:);
  methods[58].selector = @selector(truncatedCompareToWithJavaUtilDate:withJavaUtilDate:withInt:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "fields", "[[I", .constantValue.asLong = 0, 0x1a, -1, 57, -1, -1 },
  ...
  static const void *ptrTable[] = { "isSameDay", "LJavaUtilDate;LJavaUtilDate;", "LJavaUtilCalendar;LJavaUtilCalendar;", "isSameInstant", "isSameLocalTime", "parseDate", "LNSString;[LNSString;", "LJavaTextParseException;", "LNSString;LJavaUtilLocale;[LNSString;", "parseDateStrictly", "parseDateWithLeniency", "LNSString;LJavaUtilLocale;[LNSString;Z", "addYears", "LJavaUtilDate;I", "addMonths", "addWeeks", "addDays", "addHours", "addMinutes", "addSeconds", "addMilliseconds", "add", "LJavaUtilDate;II", "setYears", "setMonths", "setDays", "setHours", "setMinutes", "setSeconds", "setMilliseconds", "set", "toCalendar", "LJavaUtilDate;", "LJavaUtilDate;LJavaUtilTimeZone;", "round", "LJavaUtilCalendar;I", "LNSObject;I", "truncate", "ceiling", "modify", "LJavaUtilCalendar;ILOrgApacheCommonsLang3TimeDateUtils_ModifyType;", "iterator", "(Ljava/util/Date;I)Ljava/util/Iterator<Ljava/util/Calendar;>;", "(Ljava/util/Calendar;I)Ljava/util/Iterator<Ljava/util/Calendar;>;", "(Ljava/lang/Object;I)Ljava/util/Iterator<*>;", "getFragmentInMilliseconds", "getFragmentInSeconds", "getFragmentInMinutes", "getFragmentInHours", "getFragmentInDays", "getFragment", "LJavaUtilDate;ILJavaUtilConcurrentTimeUnit;", "LJavaUtilCalendar;ILJavaUtilConcurrentTimeUnit;", "truncatedEquals", "LJavaUtilCalendar;LJavaUtilCalendar;I", "LJavaUtilDate;LJavaUtilDate;I", "truncatedCompareTo", &OrgApacheCommonsLang3TimeDateUtils_fields, "LOrgApacheCommonsLang3TimeDateUtils_ModifyType;LOrgApacheCommonsLang3TimeDateUtils_DateIterator;" };
  static const J2ObjcClassInfo _OrgApacheCommonsLang3TimeDateUtils = { "DateUtils", "org.apache.commons.lang3.time", ptrTable, methods, fields, 7, 0x1, 59, 12, -1, 58, -1, -1, -1 };
  return &_OrgApacheCommonsLang3TimeDateUtils;
}

+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeDateUtils class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3TimeDateUtils_fields, [IOSObjectArray newArrayWithObjects:(id[]){ [IOSIntArray arrayWithInts:(jint[]){ JavaUtilCalendar_MILLISECOND } count:1], [IOSIntArray arrayWithInts:(jint[]){ JavaUtilCalendar_SECOND } count:1], [IOSIntArray arrayWithInts:(jint[]){ JavaUtilCalendar_MINUTE } count:1], [IOSIntArray arrayWithInts:(jint[]){ JavaUtilCalendar_HOUR_OF_DAY, JavaUtilCalendar_HOUR } count:2], [IOSIntArray arrayWithInts:(jint[]){ JavaUtilCalendar_DATE, JavaUtilCalendar_DAY_OF_MONTH, JavaUtilCalendar_AM_PM } count:3], [IOSIntArray arrayWithInts:(jint[]){ JavaUtilCalendar_MONTH, OrgApacheCommonsLang3TimeDateUtils_SEMI_MONTH } count:2], [IOSIntArray arrayWithInts:(jint[]){ JavaUtilCalendar_YEAR } count:1], [IOSIntArray arrayWithInts:(jint[]){ JavaUtilCalendar_ERA } count:1] } count:8 type:IOSClass_intArray(1)]);
...
JavaUtilDate *OrgApacheCommonsLang3TimeDateUtils_parseDateStrictlyWithNSString_withJavaUtilLocale_withNSStringArray_(NSString *str, JavaUtilLocale *locale, IOSObjectArray *parsePatterns) {
  OrgApacheCommonsLang3TimeDateUtils_initialize();
  return OrgApacheCommonsLang3TimeDateUtils_parseDateWithLeniencyWithNSString_withJavaUtilLocale_withNSStringArray_withBoolean_(str, locale, parsePatterns, false);
}
...
JavaUtilDate *OrgApacheCommonsLang3TimeDateUtils_parseDateWithLeniencyWithNSString_withJavaUtilLocale_withNSStringArray_withBoolean_(NSString *str, JavaUtilLocale *locale, IOSObjectArray *parsePatterns, jboolean lenient) {
  ...
  if (str == nil || parsePatterns == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Date and Patterns must not be null");
  }
  JavaUtilTimeZone *tz = JavaUtilTimeZone_getDefault();
  JavaUtilLocale *lcl = locale == nil ? JavaUtilLocale_getDefault() : locale;
  JavaTextParsePosition *pos = create_JavaTextParsePosition_initWithInt_(0);
  JavaUtilCalendar *calendar = JavaUtilCalendar_getInstanceWithJavaUtilTimeZone_withJavaUtilLocale_(tz, lcl);
  [((JavaUtilCalendar *) nil_chk(calendar)) setLenientWithBoolean:lenient];
  {
    ...
    while (b__ < e__) {
      ...
      OrgApacheCommonsLang3TimeFastDateParser *fdp = create_OrgApacheCommonsLang3TimeFastDateParser_initWithNSString_withJavaUtilTimeZone_withJavaUtilLocale_(parsePattern, tz, lcl);
      [calendar clear];
      @try {
        if ([fdp parseWithNSString:str withJavaTextParsePosition:pos withJavaUtilCalendar:calendar] && [pos getIndex] == ((jint) [str length])) {
          return [calendar getTime];
        }
      }
      @catch (JavaLangIllegalArgumentException *ignore) {
      }
      [pos setIndexWithInt:0];
    }
  }
  @throw create_JavaTextParseException_initWithNSString_withInt_(JreStrcat("$$", @"Unable to parse the date: ", str), -1);
}
...
JavaUtilCalendar *OrgApacheCommonsLang3TimeDateUtils_toCalendarWithJavaUtilDate_withJavaUtilTimeZone_(JavaUtilDate *date, JavaUtilTimeZone *tz) {
  OrgApacheCommonsLang3TimeDateUtils_initialize();
  JavaUtilCalendar *c = JavaUtilCalendar_getInstanceWithJavaUtilTimeZone_(tz);
  [((JavaUtilCalendar *) nil_chk(c)) setTimeWithJavaUtilDate:date];
  return c;
}
...
JavaUtilDate *OrgApacheCommonsLang3TimeDateUtils_roundWithId_withInt_(id date, jint field) {
  ...
  if ([date isKindOfClass:[JavaUtilDate class]]) {
    ...
    @throw create_JavaLangClassCastException_initWithNSString_(JreStrcat("$@", @"Could not round ", date));
  }
}
...
JavaUtilDate *OrgApacheCommonsLang3TimeDateUtils_truncateWithId_withInt_(id date, jint field) {
  ...
  if ([date isKindOfClass:[JavaUtilDate class]]) {
    ...
    @throw create_JavaLangClassCastException_initWithNSString_(JreStrcat("$@", @"Could not truncate ", date));
  }
}
...
JavaUtilDate *OrgApacheCommonsLang3TimeDateUtils_ceilingWithId_withInt_(id date, jint field) {
  ...
  if ([date isKindOfClass:[JavaUtilDate class]]) {
    ...
    @throw create_JavaLangClassCastException_initWithNSString_(JreStrcat("$@", @"Could not find ceiling of for type: ", [date java_getClass]));
  }
}
...
void OrgApacheCommonsLang3TimeDateUtils_modifyWithJavaUtilCalendar_withInt_withOrgApacheCommonsLang3TimeDateUtils_ModifyType_(JavaUtilCalendar *val, jint field, OrgApacheCommonsLang3TimeDateUtils_ModifyType *modType) {
  ...
  if ([((JavaUtilCalendar *) nil_chk(val)) getWithInt:JavaUtilCalendar_YEAR] > 280000000) {
    @throw create_JavaLangArithmeticException_initWithNSString_(@"Calendar value too large for accurate calculations");
  }
  ...
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$", @"The field ", field, @" is not supported"));
}
...
id<JavaUtilIterator> OrgApacheCommonsLang3TimeDateUtils_iteratorWithJavaUtilCalendar_withInt_(JavaUtilCalendar *focus, jint rangeStyle) {
  ...
  switch (rangeStyle) {
    ...
    break;
    default:
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$", @"The range style ", rangeStyle, @" is not valid."));
  }
  ...
  return create_OrgApacheCommonsLang3TimeDateUtils_DateIterator_initWithJavaUtilCalendar_withJavaUtilCalendar_(start, end);
}
...
id<JavaUtilIterator> OrgApacheCommonsLang3TimeDateUtils_iteratorWithId_withInt_(id focus, jint rangeStyle) {
  ...
  if ([focus isKindOfClass:[JavaUtilDate class]]) {
    ...
    @throw create_JavaLangClassCastException_initWithNSString_(JreStrcat("$@", @"Could not iterate based on ", focus));
  }
}
...
jlong OrgApacheCommonsLang3TimeDateUtils_getFragmentWithJavaUtilCalendar_withInt_withJavaUtilConcurrentTimeUnit_(JavaUtilCalendar *calendar, jint fragment, JavaUtilConcurrentTimeUnit *unit) {
  ...
  switch (fragment) {
    ...
    break;
    default:
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$", @"The fragment ", fragment, @" is not supported"));
  }
  return result;
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeDateUtils_ModifyType class]) {
    ...
    for (jint i = 0; i < 3; i++) {
      (OrgApacheCommonsLang3TimeDateUtils_ModifyType_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      OrgApacheCommonsLang3TimeDateUtils_ModifyType_initWithNSString_withInt_(e, names[i], i);
    }
...
void OrgApacheCommonsLang3TimeDateUtils_DateIterator_initWithJavaUtilCalendar_withJavaUtilCalendar_(OrgApacheCommonsLang3TimeDateUtils_DateIterator *self, JavaUtilCalendar *startFinal, JavaUtilCalendar *endFinal) {
  NSObject_init(self);
  JreStrongAssign(&self->endFinal_, endFinal);
  JreStrongAssign(&self->spot_, startFinal);
