...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_truncateWithNSString_withInt_(NSString *str, jint maxWidth);

FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_truncateWithNSString_withInt_withInt_(NSString *str, jint offset, jint maxWidth);
...
FOUNDATION_EXPORT jint OrgApacheCommonsLang3StringUtils_compareWithNSString_withNSString_(NSString *str1, NSString *str2);

FOUNDATION_EXPORT jint OrgApacheCommonsLang3StringUtils_compareWithNSString_withNSString_withBoolean_(NSString *str1, NSString *str2, jboolean nullIsLess);

FOUNDATION_EXPORT jint OrgApacheCommonsLang3StringUtils_compareIgnoreCaseWithNSString_withNSString_(NSString *str1, NSString *str2);

FOUNDATION_EXPORT jint OrgApacheCommonsLang3StringUtils_compareIgnoreCaseWithNSString_withNSString_withBoolean_(NSString *str1, NSString *str2, jboolean nullIsLess);

FOUNDATION_EXPORT jboolean OrgApacheCommonsLang3StringUtils_equalsAnyWithJavaLangCharSequence_withJavaLangCharSequenceArray_(id<JavaLangCharSequence> string, IOSObjectArray *searchStrings);

FOUNDATION_EXPORT jboolean OrgApacheCommonsLang3StringUtils_equalsAnyIgnoreCaseWithJavaLangCharSequence_withJavaLangCharSequenceArray_(id<JavaLangCharSequence> string, IOSObjectArray *searchStrings);
...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_joinWithWithNSString_withNSObjectArray_(NSString *separator, IOSObjectArray *objects);
...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_removeIgnoreCaseWithNSString_withNSString_(NSString *str, NSString *remove);

FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_removeWithNSString_withChar_(NSString *str, jchar remove);

FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_removeAllWithNSString_withNSString_(NSString *text, NSString *regex);

FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_removeFirstWithNSString_withNSString_(NSString *text, NSString *regex);
...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_replaceOnceIgnoreCaseWithNSString_withNSString_withNSString_(NSString *text, NSString *searchString, NSString *replacement);
...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_replaceAllWithNSString_withNSString_withNSString_(NSString *text, NSString *regex, NSString *replacement);

FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_replaceFirstWithNSString_withNSString_withNSString_(NSString *text, NSString *regex, NSString *replacement);
...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_replaceIgnoreCaseWithNSString_withNSString_withNSString_(NSString *text, NSString *searchString, NSString *replacement);
...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_replaceIgnoreCaseWithNSString_withNSString_withNSString_withInt_(NSString *text, NSString *searchString, NSString *replacement, jint max);
...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_rotateWithNSString_withInt_(NSString *str, jint shift);
...
FOUNDATION_EXPORT jboolean OrgApacheCommonsLang3StringUtils_startsWithAnyWithJavaLangCharSequence_withJavaLangCharSequenceArray_(id<JavaLangCharSequence> sequence, IOSObjectArray *searchStrings);
...
FOUNDATION_EXPORT jboolean OrgApacheCommonsLang3StringUtils_endsWithAnyWithJavaLangCharSequence_withJavaLangCharSequenceArray_(id<JavaLangCharSequence> sequence, IOSObjectArray *searchStrings);
...
FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_wrapIfMissingWithNSString_withChar_(NSString *str, jchar wrapWith);

FOUNDATION_EXPORT NSString *OrgApacheCommonsLang3StringUtils_wrapIfMissingWithNSString_withNSString_(NSString *str, NSString *wrapWith);
