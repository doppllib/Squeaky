...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/time/DurationFormatUtils.java
//
...
NSString *OrgApacheCommonsLang3TimeDurationFormatUtils_formatDurationWordsWithLong_withBoolean_withBoolean_(jlong durationMillis, jboolean suppressLeadingZeroElements, jboolean suppressTrailingZeroElements) {
  ...
  if (suppressLeadingZeroElements) {
    ...
    NSString *tmp = OrgApacheCommonsLang3StringUtils_replaceOnceWithNSString_withNSString_withNSString_(duration, @" 0 days", OrgApacheCommonsLang3StringUtils_EMPTY);
    if (((jint) [((NSString *) nil_chk(tmp)) length]) != ((jint) [duration length])) {
      duration = tmp;
      tmp = OrgApacheCommonsLang3StringUtils_replaceOnceWithNSString_withNSString_withNSString_(duration, @" 0 hours", OrgApacheCommonsLang3StringUtils_EMPTY);
      if (((jint) [((NSString *) nil_chk(tmp)) length]) != ((jint) [duration length])) {
        duration = tmp;
        tmp = OrgApacheCommonsLang3StringUtils_replaceOnceWithNSString_withNSString_withNSString_(duration, @" 0 minutes", OrgApacheCommonsLang3StringUtils_EMPTY);
        duration = tmp;
        if (((jint) [((NSString *) nil_chk(tmp)) length]) != ((jint) [((NSString *) nil_chk(duration)) length])) {
          duration = OrgApacheCommonsLang3StringUtils_replaceOnceWithNSString_withNSString_withNSString_(tmp, @" 0 seconds", OrgApacheCommonsLang3StringUtils_EMPTY);
        }
      }
    }
    if (((jint) [((NSString *) nil_chk(duration)) length]) != 0) {
      duration = [duration java_substring:1];
    }
  }
  if (suppressTrailingZeroElements) {
    NSString *tmp = OrgApacheCommonsLang3StringUtils_replaceOnceWithNSString_withNSString_withNSString_(duration, @" 0 seconds", OrgApacheCommonsLang3StringUtils_EMPTY);
    if (((jint) [((NSString *) nil_chk(tmp)) length]) != ((jint) [((NSString *) nil_chk(duration)) length])) {
      duration = tmp;
      tmp = OrgApacheCommonsLang3StringUtils_replaceOnceWithNSString_withNSString_withNSString_(duration, @" 0 minutes", OrgApacheCommonsLang3StringUtils_EMPTY);
      if (((jint) [((NSString *) nil_chk(tmp)) length]) != ((jint) [duration length])) {
        ...
        tmp = OrgApacheCommonsLang3StringUtils_replaceOnceWithNSString_withNSString_withNSString_(duration, @" 0 hours", OrgApacheCommonsLang3StringUtils_EMPTY);
        if (((jint) [((NSString *) nil_chk(tmp)) length]) != ((jint) [duration length])) {
          duration = OrgApacheCommonsLang3StringUtils_replaceOnceWithNSString_withNSString_withNSString_(tmp, @" 0 days", OrgApacheCommonsLang3StringUtils_EMPTY);
        }
      }
    }
  }
  ...
  jboolean lastOutputSeconds = false;
  {
    ...
    while (b__ < e__) {
      ...
      if ([value isKindOfClass:[JavaLangStringBuilder class]]) {
        ...
        if ([nil_chk(value) isEqual:OrgApacheCommonsLang3TimeDurationFormatUtils_y]) {
        ...
        else if ([value isEqual:OrgApacheCommonsLang3TimeDurationFormatUtils_M]) {
        ...
        else if ([value isEqual:OrgApacheCommonsLang3TimeDurationFormatUtils_d]) {
        ...
        else if ([value isEqual:OrgApacheCommonsLang3TimeDurationFormatUtils_H]) {
        ...
        else if ([value isEqual:OrgApacheCommonsLang3TimeDurationFormatUtils_s]) {
...
IOSObjectArray *OrgApacheCommonsLang3TimeDurationFormatUtils_lexxWithNSString_(NSString *format) {
  OrgApacheCommonsLang3TimeDurationFormatUtils_initialize();
  JavaUtilArrayList *list = create_JavaUtilArrayList_initWithInt_(((jint) [((NSString *) nil_chk(format)) length]));
  jboolean inLiteral = false;
  JavaLangStringBuilder *buffer = nil;
  OrgApacheCommonsLang3TimeDurationFormatUtils_Token *previous = nil;
  for (jint i = 0; i < ((jint) [format length]); i++) {
    ...
    if (value != nil) {
      if (previous != nil && [nil_chk([previous getValue]) isEqual:value]) {
        [previous increment];
      }
      else {
