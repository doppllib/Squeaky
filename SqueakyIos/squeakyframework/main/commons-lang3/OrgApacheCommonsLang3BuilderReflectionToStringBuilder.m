...
__attribute__((unused)) static id OrgApacheCommonsLang3BuilderReflectionToStringBuilder_checkNotNullWithId_(id obj);
...
+ (id)checkNotNullWithId:(id)obj {
  return OrgApacheCommonsLang3BuilderReflectionToStringBuilder_checkNotNullWithId_(obj);
}
...
- (jboolean)acceptWithJavaLangReflectField:(JavaLangReflectField *)field {
  ...
  if ([field isAnnotationPresentWithIOSClass:OrgApacheCommonsLang3BuilderToStringExclude_class_()]) {
    return false;
  }
  return true;
}
...
- (void)appendFieldsInWithIOSClass:(IOSClass *)clazz {
  if ([((IOSClass *) nil_chk(clazz)) isArray]) {
    [self reflectionAppendArrayWithId:[self getObject]];
    return;
  }
    ...
    while (b__ < e__) {
      ...
      if ([self acceptWithJavaLangReflectField:field]) {
        @try {
          ...
          [self appendWithNSString:fieldName withId:fieldValue];
        }
        @catch (JavaLangIllegalAccessException *ex) {
          @throw create_JavaLangInternalError_initWithNSString_(JreStrcat("$$", @"Unexpected IllegalAccessException: ", [((JavaLangIllegalAccessException *) nil_chk(ex)) getMessage]));
        }
      }
    }
  }
...
- (OrgApacheCommonsLang3BuilderReflectionToStringBuilder *)setExcludeFieldNamesWithNSStringArray:(IOSObjectArray *)excludeFieldNamesParam {
  if (excludeFieldNamesParam == nil) {
    JreStrongAssign(&self->excludeFieldNames_, nil);
  }
  else {
    JreStrongAssign(&self->excludeFieldNames_, OrgApacheCommonsLang3BuilderReflectionToStringBuilder_toNoNullStringArrayWithNSObjectArray_(excludeFieldNamesParam));
...
- (void)setUpToClassWithIOSClass:(IOSClass *)clazz {
  if (clazz != nil) {
    ...
    if (object != nil && [clazz isInstance:object] == false) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Specified class is not a superclass of the object");
    }
  }
  JreStrongAssign(&self->upToClass_, clazz);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSObject;", 0xa, 15, 1, -1, -1, -1, -1 },
    ...
    { NULL, "LNSObject;", 0x4, 25, 20, 26, -1, -1, -1 },
    { NULL, "Z", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "Z", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LOrgApacheCommonsLang3BuilderReflectionToStringBuilder;", 0x1, 27, 1, -1, -1, -1, -1 },
    { NULL, "V", 0x1, 28, 29, -1, -1, -1, -1 },
    { NULL, "V", 0x1, 30, 29, -1, -1, -1, -1 },
    { NULL, "LOrgApacheCommonsLang3BuilderReflectionToStringBuilder;", 0x81, 31, 32, -1, -1, -1, -1 },
    { NULL, "V", 0x1, 33, 22, -1, 23, -1, -1 },
  ...
  methods[9].selector = @selector(checkNotNullWithId:);
  methods[10].selector = @selector(initWithId:);
  methods[11].selector = @selector(initWithId:withOrgApacheCommonsLang3BuilderToStringStyle:);
  methods[12].selector = @selector(initWithId:withOrgApacheCommonsLang3BuilderToStringStyle:withJavaLangStringBuffer:);
  methods[13].selector = @selector(initWithId:withOrgApacheCommonsLang3BuilderToStringStyle:withJavaLangStringBuffer:withIOSClass:withBoolean:withBoolean:);
  methods[14].selector = @selector(acceptWithJavaLangReflectField:);
  methods[15].selector = @selector(appendFieldsInWithIOSClass:);
  methods[16].selector = @selector(getExcludeFieldNames);
  methods[17].selector = @selector(getUpToClass);
  methods[18].selector = @selector(getValueWithJavaLangReflectField:);
  methods[19].selector = @selector(isAppendStatics);
  methods[20].selector = @selector(isAppendTransients);
  methods[21].selector = @selector(reflectionAppendArrayWithId:);
  methods[22].selector = @selector(setAppendStaticsWithBoolean:);
  methods[23].selector = @selector(setAppendTransientsWithBoolean:);
  methods[24].selector = @selector(setExcludeFieldNamesWithNSStringArray:);
  methods[25].selector = @selector(setUpToClassWithIOSClass:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "upToClass_", "LIOSClass;", .constantValue.asLong = 0, 0x2, -1, -1, 34, -1 },
  };
  static const void *ptrTable[] = { "toString", "LNSObject;", "LNSObject;LOrgApacheCommonsLang3BuilderToStringStyle;", "LNSObject;LOrgApacheCommonsLang3BuilderToStringStyle;Z", "LNSObject;LOrgApacheCommonsLang3BuilderToStringStyle;ZZ", "LNSObject;LOrgApacheCommonsLang3BuilderToStringStyle;ZZLIOSClass;", "<T:Ljava/lang/Object;>(TT;Lorg/apache/commons/lang3/builder/ToStringStyle;ZZLjava/lang/Class<-TT;>;)Ljava/lang/String;", "toStringExclude", "LNSObject;LJavaUtilCollection;", "(Ljava/lang/Object;Ljava/util/Collection<Ljava/lang/String;>;)Ljava/lang/String;", "toNoNullStringArray", "LJavaUtilCollection;", "(Ljava/util/Collection<Ljava/lang/String;>;)[Ljava/lang/String;", "[LNSObject;", "LNSObject;[LNSString;", "checkNotNull", "LNSObject;LOrgApacheCommonsLang3BuilderToStringStyle;LJavaLangStringBuffer;", "LNSObject;LOrgApacheCommonsLang3BuilderToStringStyle;LJavaLangStringBuffer;LIOSClass;ZZ", "<T:Ljava/lang/Object;>(TT;Lorg/apache/commons/lang3/builder/ToStringStyle;Ljava/lang/StringBuffer;Ljava/lang/Class<-TT;>;ZZ)V", "accept", "LJavaLangReflectField;", "appendFieldsIn", "LIOSClass;", "(Ljava/lang/Class<*>;)V", "()Ljava/lang/Class<*>;", "getValue", "LJavaLangIllegalArgumentException;LJavaLangIllegalAccessException;", "reflectionAppendArray", "setAppendStatics", "Z", "setAppendTransients", "setExcludeFieldNames", "[LNSString;", "setUpToClass", "Ljava/lang/Class<*>;" };
  static const J2ObjcClassInfo _OrgApacheCommonsLang3BuilderReflectionToStringBuilder = { "ReflectionToStringBuilder", "org.apache.commons.lang3.builder", ptrTable, methods, fields, 7, 0x1, 27, 4, -1, -1, -1, -1, -1 };
...
NSString *OrgApacheCommonsLang3BuilderReflectionToStringBuilder_toStringWithId_withOrgApacheCommonsLang3BuilderToStringStyle_withBoolean_withBoolean_withIOSClass_(id object, OrgApacheCommonsLang3BuilderToStringStyle *style, jboolean outputTransients, jboolean outputStatics, IOSClass *reflectUpToClass) {
  OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initialize();
  return [create_OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initWithId_withOrgApacheCommonsLang3BuilderToStringStyle_withJavaLangStringBuffer_withIOSClass_withBoolean_withBoolean_(object, style, nil, reflectUpToClass, outputTransients, outputStatics) description];
}
...
IOSObjectArray *OrgApacheCommonsLang3BuilderReflectionToStringBuilder_toNoNullStringArrayWithNSObjectArray_(IOSObjectArray *array) {
  OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initialize();
  id<JavaUtilList> list = create_JavaUtilArrayList_initWithInt_(((IOSObjectArray *) nil_chk(array))->size_);
  {
...
NSString *OrgApacheCommonsLang3BuilderReflectionToStringBuilder_toStringExcludeWithId_withNSStringArray_(id object, IOSObjectArray *excludeFieldNames) {
  OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initialize();
  return [((OrgApacheCommonsLang3BuilderReflectionToStringBuilder *) nil_chk([create_OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initWithId_(object) setExcludeFieldNamesWithNSStringArray:excludeFieldNames])) description];
}

id OrgApacheCommonsLang3BuilderReflectionToStringBuilder_checkNotNullWithId_(id obj) {
  OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initialize();
  if (obj == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"The Object passed in should not be null.");
  }
  return obj;
}
...
void OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initWithId_(OrgApacheCommonsLang3BuilderReflectionToStringBuilder *self, id object) {
  OrgApacheCommonsLang3BuilderToStringBuilder_initWithId_(self, OrgApacheCommonsLang3BuilderReflectionToStringBuilder_checkNotNullWithId_(object));
  self->appendStatics_ = false;
  self->appendTransients_ = false;
  JreStrongAssign(&self->upToClass_, nil);
}
...
void OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initWithId_withOrgApacheCommonsLang3BuilderToStringStyle_(OrgApacheCommonsLang3BuilderReflectionToStringBuilder *self, id object, OrgApacheCommonsLang3BuilderToStringStyle *style) {
  OrgApacheCommonsLang3BuilderToStringBuilder_initWithId_withOrgApacheCommonsLang3BuilderToStringStyle_(self, OrgApacheCommonsLang3BuilderReflectionToStringBuilder_checkNotNullWithId_(object), style);
  self->appendStatics_ = false;
  self->appendTransients_ = false;
  JreStrongAssign(&self->upToClass_, nil);
}
...
void OrgApacheCommonsLang3BuilderReflectionToStringBuilder_initWithId_withOrgApacheCommonsLang3BuilderToStringStyle_withJavaLangStringBuffer_(OrgApacheCommonsLang3BuilderReflectionToStringBuilder *self, id object, OrgApacheCommonsLang3BuilderToStringStyle *style, JavaLangStringBuffer *buffer) {
  OrgApacheCommonsLang3BuilderToStringBuilder_initWithId_withOrgApacheCommonsLang3BuilderToStringStyle_withJavaLangStringBuffer_(self, OrgApacheCommonsLang3BuilderReflectionToStringBuilder_checkNotNullWithId_(object), style, buffer);
  self->appendStatics_ = false;
  self->appendTransients_ = false;
  JreStrongAssign(&self->upToClass_, nil);
}
