...
inline JavaUtilRandom *OrgApacheCommonsLang3RandomUtils_get_RANDOM();
...
+ (jboolean)nextBoolean {
  return OrgApacheCommonsLang3RandomUtils_nextBoolean();
}
...
+ (jint)nextInt {
  return OrgApacheCommonsLang3RandomUtils_nextInt();
}
...
+ (jlong)nextLong {
  return OrgApacheCommonsLang3RandomUtils_nextLong();
}
...
+ (jdouble)nextDouble {
  return OrgApacheCommonsLang3RandomUtils_nextDouble();
}
...
+ (jfloat)nextFloat {
  return OrgApacheCommonsLang3RandomUtils_nextFloat();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(nextBoolean);
  methods[2].selector = @selector(nextBytesWithInt:);
  methods[3].selector = @selector(nextIntWithInt:withInt:);
  methods[4].selector = @selector(nextInt);
  methods[5].selector = @selector(nextLongWithLong:withLong:);
  methods[6].selector = @selector(nextLong);
  methods[7].selector = @selector(nextDoubleWithDouble:withDouble:);
  methods[8].selector = @selector(nextDouble);
  methods[9].selector = @selector(nextFloatWithFloat:withFloat:);
  methods[10].selector = @selector(nextFloat);
  ...
  static const J2ObjcClassInfo _OrgApacheCommonsLang3RandomUtils = { "RandomUtils", "org.apache.commons.lang3", ptrTable, methods, fields, 7, 0x1, 11, 1, -1, -1, -1, -1, -1 };
...
jboolean OrgApacheCommonsLang3RandomUtils_nextBoolean() {
  OrgApacheCommonsLang3RandomUtils_initialize();
  return [((JavaUtilRandom *) nil_chk(OrgApacheCommonsLang3RandomUtils_RANDOM)) nextBoolean];
}
...
jint OrgApacheCommonsLang3RandomUtils_nextInt() {
  OrgApacheCommonsLang3RandomUtils_initialize();
  return OrgApacheCommonsLang3RandomUtils_nextIntWithInt_withInt_(0, JavaLangInteger_MAX_VALUE);
}
...
jlong OrgApacheCommonsLang3RandomUtils_nextLong() {
  OrgApacheCommonsLang3RandomUtils_initialize();
  return OrgApacheCommonsLang3RandomUtils_nextLongWithLong_withLong_(0, JavaLangLong_MAX_VALUE);
}
...
jdouble OrgApacheCommonsLang3RandomUtils_nextDouble() {
  OrgApacheCommonsLang3RandomUtils_initialize();
  return OrgApacheCommonsLang3RandomUtils_nextDoubleWithDouble_withDouble_(0, JavaLangDouble_MAX_VALUE);
}
...
jfloat OrgApacheCommonsLang3RandomUtils_nextFloat() {
  OrgApacheCommonsLang3RandomUtils_initialize();
  return OrgApacheCommonsLang3RandomUtils_nextFloatWithFloat_withFloat_(0, JavaLangFloat_MAX_VALUE);
}
