...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/time/FormatCache.java
//
...
inline id<JavaUtilConcurrentConcurrentMap> OrgApacheCommonsLang3TimeFormatCache_get_cDateTimeInstanceCache();
...
- (JavaTextFormat *)getInstanceWithNSString:(NSString *)pattern
                       withJavaUtilTimeZone:(JavaUtilTimeZone *)timeZone
                         withJavaUtilLocale:(JavaUtilLocale *)locale {
  if (pattern == nil) {
    @throw create_JavaLangNullPointerException_initWithNSString_(@"pattern must not be null");
  }
  if (timeZone == nil) {
  ...
  OrgApacheCommonsLang3TimeFormatCache_MultipartKey *key = create_OrgApacheCommonsLang3TimeFormatCache_MultipartKey_initWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ pattern, timeZone, locale } count:3 type:NSObject_class_()]);
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TimeFormatCache class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3TimeFormatCache_cDateTimeInstanceCache, new_JavaUtilConcurrentConcurrentHashMap_initWithInt_(7));
...
void OrgApacheCommonsLang3TimeFormatCache_init(OrgApacheCommonsLang3TimeFormatCache *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->cInstanceCache_, new_JavaUtilConcurrentConcurrentHashMap_initWithInt_(7));
}
...
NSString *OrgApacheCommonsLang3TimeFormatCache_getPatternForStyleWithJavaLangInteger_withJavaLangInteger_withJavaUtilLocale_(JavaLangInteger *dateStyle, JavaLangInteger *timeStyle, JavaUtilLocale *locale) {
  ...
  OrgApacheCommonsLang3TimeFormatCache_MultipartKey *key = create_OrgApacheCommonsLang3TimeFormatCache_MultipartKey_initWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ dateStyle, timeStyle, locale } count:3 type:NSObject_class_()]);
  ...
  if (pattern == nil) {
    ...
    @catch (JavaLangClassCastException *ex) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"No date time pattern for locale: ", locale));
    }
  }
  return pattern;
}
