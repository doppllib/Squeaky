...
#include "OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer.h"
...
withOrgApacheCommonsLang3ConcurrentBackgroundInitializer:(OrgApacheCommonsLang3ConcurrentBackgroundInitializer *)init_ {
  if (name == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Name of child initializer must not be null!");
  }
  if (init_ == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Child initializer must not be null!");
  }
  @synchronized(self) {
    if ([self isStarted]) {
      @throw create_JavaLangIllegalStateException_initWithNSString_(@"addInitializer() must not be called after start()!");
    }
    [((id<JavaUtilMap>) nil_chk(childInitializers_)) putWithId:name withId:init_];
  }
}
...
- (OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer_MultiBackgroundInitializerResults *)initialize__ {
  ...
  @synchronized(self) {
    inits = create_JavaUtilHashMap_initWithJavaUtilMap_(childInitializers_);
  }
  ...
  id<JavaUtilMap> results = create_JavaUtilHashMap_init();
  id<JavaUtilMap> excepts = create_JavaUtilHashMap_init();
  for (id<JavaUtilMap_Entry> __strong e in nil_chk([inits entrySet])) {
    @try {
      [results putWithId:[((id<JavaUtilMap_Entry>) nil_chk(e)) getKey] withId:[((OrgApacheCommonsLang3ConcurrentBackgroundInitializer *) nil_chk([e getValue])) get]];
    }
    @catch (OrgApacheCommonsLang3ConcurrentConcurrentException *cex) {
      [excepts putWithId:[e getKey] withId:cex];
    }
  }
  return create_OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer_MultiBackgroundInitializerResults_initWithJavaUtilMap_withJavaUtilMap_withJavaUtilMap_(inits, results, excepts);
}

- (void)dealloc {
  RELEASE_(childInitializers_);
  [super dealloc];
}
...
void OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer_init(OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer *self) {
  ...
  JreStrongAssignAndConsume(&self->childInitializers_, new_JavaUtilHashMap_init());
}
...
- (id)getResultObjectWithNSString:(NSString *)name {
  OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer_MultiBackgroundInitializerResults_checkNameWithNSString_(self, name);
...
- (void)dealloc {
  RELEASE_(initializers_);
  RELEASE_(resultObjects_);
...
void OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer_MultiBackgroundInitializerResults_initWithJavaUtilMap_withJavaUtilMap_withJavaUtilMap_(OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer_MultiBackgroundInitializerResults *self, id<JavaUtilMap> inits, id<JavaUtilMap> results, id<JavaUtilMap> excepts) {
  NSObject_init(self);
  JreStrongAssign(&self->initializers_, inits);
  JreStrongAssign(&self->resultObjects_, results);
  JreStrongAssign(&self->exceptions_, excepts);
}
...
OrgApacheCommonsLang3ConcurrentBackgroundInitializer *OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer_MultiBackgroundInitializerResults_checkNameWithNSString_(OrgApacheCommonsLang3ConcurrentMultiBackgroundInitializer_MultiBackgroundInitializerResults *self, NSString *name) {
  ...
  if (init_ == nil) {
    @throw create_JavaUtilNoSuchElementException_initWithNSString_(JreStrcat("$$", @"No child initializer with name ", name));
  }
  return init_;
}
