...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/builder/EqualsBuilder.java
//
...
#include "OrgApacheCommonsLang3BuilderIDKey.h"
...
- (void)appendArrayWithId:(id)lhs
                   withId:(id)rhs;

@end

inline JavaLangThreadLocal *OrgApacheCommonsLang3BuilderEqualsBuilder_get_REGISTRY();
...
__attribute__((unused)) static void OrgApacheCommonsLang3BuilderEqualsBuilder_register__WithId_withId_(id lhs, id rhs);

__attribute__((unused)) static void OrgApacheCommonsLang3BuilderEqualsBuilder_unregisterWithId_withId_(id lhs, id rhs);
...
__attribute__((unused)) static void OrgApacheCommonsLang3BuilderEqualsBuilder_appendArrayWithId_withId_(OrgApacheCommonsLang3BuilderEqualsBuilder *self, id lhs, id rhs);
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithId:(id)lhs
  ...
  if (![lhsClass isArray]) {
    ...
    OrgApacheCommonsLang3BuilderEqualsBuilder_appendArrayWithId_withId_(self, lhs, rhs);
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithNSObjectArray:(IOSObjectArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithId:IOSObjectArray_Get(lhs, i) withId:IOSObjectArray_Get(rhs, i)];
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithLongArray:(IOSLongArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithLong:IOSLongArray_Get(lhs, i) withLong:IOSLongArray_Get(rhs, i)];
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithIntArray:(IOSIntArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithInt:IOSIntArray_Get(lhs, i) withInt:IOSIntArray_Get(rhs, i)];
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithShortArray:(IOSShortArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithShort:IOSShortArray_Get(lhs, i) withShort:IOSShortArray_Get(rhs, i)];
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithCharArray:(IOSCharArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithChar:IOSCharArray_Get(lhs, i) withChar:IOSCharArray_Get(rhs, i)];
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithByteArray:(IOSByteArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithByte:IOSByteArray_Get(lhs, i) withByte:IOSByteArray_Get(rhs, i)];
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithDoubleArray:(IOSDoubleArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithDouble:IOSDoubleArray_Get(lhs, i) withDouble:IOSDoubleArray_Get(rhs, i)];
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithFloatArray:(IOSFloatArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithFloat:IOSFloatArray_Get(lhs, i) withFloat:IOSFloatArray_Get(rhs, i)];
  }
  return self;
}
...
- (OrgApacheCommonsLang3BuilderEqualsBuilder *)appendWithBooleanArray:(IOSBooleanArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && isEquals_; ++i) {
    [self appendWithBoolean:IOSBooleanArray_Get(lhs, i) withBoolean:IOSBooleanArray_Get(rhs, i)];
  }
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "V", 0xa, 5, 2, -1, -1, -1, -1 },
    { NULL, "V", 0xa, 6, 2, -1, -1, -1, -1 },
    ...
    { NULL, "LOrgApacheCommonsLang3BuilderEqualsBuilder;", 0x1, 19, 37, -1, -1, -1, -1 },
    { NULL, "Z", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LJavaLangBoolean;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x4, 38, 18, -1, -1, -1, -1 },
  ...
  methods[13].selector = @selector(appendArrayWithId:withId:);
  methods[14].selector = @selector(appendWithLong:withLong:);
  methods[15].selector = @selector(appendWithInt:withInt:);
  methods[16].selector = @selector(appendWithShort:withShort:);
  methods[17].selector = @selector(appendWithChar:withChar:);
  methods[18].selector = @selector(appendWithByte:withByte:);
  methods[19].selector = @selector(appendWithDouble:withDouble:);
  methods[20].selector = @selector(appendWithFloat:withFloat:);
  methods[21].selector = @selector(appendWithBoolean:withBoolean:);
  methods[22].selector = @selector(appendWithNSObjectArray:withNSObjectArray:);
  methods[23].selector = @selector(appendWithLongArray:withLongArray:);
  methods[24].selector = @selector(appendWithIntArray:withIntArray:);
  methods[25].selector = @selector(appendWithShortArray:withShortArray:);
  methods[26].selector = @selector(appendWithCharArray:withCharArray:);
  methods[27].selector = @selector(appendWithByteArray:withByteArray:);
  methods[28].selector = @selector(appendWithDoubleArray:withDoubleArray:);
  methods[29].selector = @selector(appendWithFloatArray:withFloatArray:);
  methods[30].selector = @selector(appendWithBooleanArray:withBooleanArray:);
  methods[31].selector = @selector(isEquals);
  methods[32].selector = @selector(build);
  methods[33].selector = @selector(setEqualsWithBoolean:);
  methods[34].selector = @selector(reset);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "REGISTRY", "LJavaLangThreadLocal;", .constantValue.asLong = 0, 0x1a, -1, 39, 40, -1 },
    { "isEquals_", "Z", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "()Ljava/util/Set<Lorg/apache/commons/lang3/tuple/Pair<Lorg/apache/commons/lang3/builder/IDKey;Lorg/apache/commons/lang3/builder/IDKey;>;>;", "getRegisterPair", "LNSObject;LNSObject;", "(Ljava/lang/Object;Ljava/lang/Object;)Lorg/apache/commons/lang3/tuple/Pair<Lorg/apache/commons/lang3/builder/IDKey;Lorg/apache/commons/lang3/builder/IDKey;>;", "isRegistered", "register", "unregister", "reflectionEquals", "LNSObject;LNSObject;LJavaUtilCollection;", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/Collection<Ljava/lang/String;>;)Z", "LNSObject;LNSObject;[LNSString;", "LNSObject;LNSObject;Z", "LNSObject;LNSObject;ZLIOSClass;[LNSString;", "(Ljava/lang/Object;Ljava/lang/Object;ZLjava/lang/Class<*>;[Ljava/lang/String;)Z", "reflectionAppend", "LNSObject;LNSObject;LIOSClass;LOrgApacheCommonsLang3BuilderEqualsBuilder;Z[LNSString;", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Class<*>;Lorg/apache/commons/lang3/builder/EqualsBuilder;Z[Ljava/lang/String;)V", "appendSuper", "Z", "append", "appendArray", "JJ", "II", "SS", "CC", "BB", "DD", "FF", "ZZ", "[LNSObject;[LNSObject;", "[J[J", "[I[I", "[S[S", "[C[C", "[B[B", "[D[D", "[F[F", "[Z[Z", "setEquals", &OrgApacheCommonsLang3BuilderEqualsBuilder_REGISTRY, "Ljava/lang/ThreadLocal<Ljava/util/Set<Lorg/apache/commons/lang3/tuple/Pair<Lorg/apache/commons/lang3/builder/IDKey;Lorg/apache/commons/lang3/builder/IDKey;>;>;>;", "Ljava/lang/Object;Lorg/apache/commons/lang3/builder/Builder<Ljava/lang/Boolean;>;" };
  static const J2ObjcClassInfo _OrgApacheCommonsLang3BuilderEqualsBuilder = { "EqualsBuilder", "org.apache.commons.lang3.builder", ptrTable, methods, fields, 7, 0x1, 35, 2, -1, -1, -1, 41, -1 };
  return &_OrgApacheCommonsLang3BuilderEqualsBuilder;
}

+ (void)initialize {
  if (self == [OrgApacheCommonsLang3BuilderEqualsBuilder class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3BuilderEqualsBuilder_REGISTRY, new_JavaLangThreadLocal_init());
...
OrgApacheCommonsLang3TuplePair *OrgApacheCommonsLang3BuilderEqualsBuilder_getRegisterPairWithId_withId_(id lhs, id rhs) {
  OrgApacheCommonsLang3BuilderEqualsBuilder_initialize();
  OrgApacheCommonsLang3BuilderIDKey *left = create_OrgApacheCommonsLang3BuilderIDKey_initWithId_(lhs);
  OrgApacheCommonsLang3BuilderIDKey *right = create_OrgApacheCommonsLang3BuilderIDKey_initWithId_(rhs);
...
void OrgApacheCommonsLang3BuilderEqualsBuilder_register__WithId_withId_(id lhs, id rhs) {
  ...
  id<JavaUtilSet> registry = OrgApacheCommonsLang3BuilderEqualsBuilder_getRegistry();
  if (registry == nil) {
    registry = create_JavaUtilHashSet_init();
    [((JavaLangThreadLocal *) nil_chk(OrgApacheCommonsLang3BuilderEqualsBuilder_REGISTRY)) setWithId:registry];
  }
  OrgApacheCommonsLang3TuplePair *pair = OrgApacheCommonsLang3BuilderEqualsBuilder_getRegisterPairWithId_withId_(lhs, rhs);
  [registry addWithId:pair];
}
...
jboolean OrgApacheCommonsLang3BuilderEqualsBuilder_reflectionEqualsWithId_withId_withBoolean_(id lhs, id rhs, jboolean testTransients) {
  OrgApacheCommonsLang3BuilderEqualsBuilder_initialize();
  return OrgApacheCommonsLang3BuilderEqualsBuilder_reflectionEqualsWithId_withId_withBoolean_withIOSClass_withNSStringArray_(lhs, rhs, testTransients, nil, [IOSObjectArray arrayWithLength:0 type:NSString_class_()]);
}
...
jboolean OrgApacheCommonsLang3BuilderEqualsBuilder_reflectionEqualsWithId_withId_withBoolean_withIOSClass_withNSStringArray_(id lhs, id rhs, jboolean testTransients, IOSClass *reflectUpToClass, IOSObjectArray *excludeFields) {
  ...
  OrgApacheCommonsLang3BuilderEqualsBuilder *equalsBuilder = create_OrgApacheCommonsLang3BuilderEqualsBuilder_init();
  @try {
    if ([testClass isArray]) {
      [equalsBuilder appendWithId:lhs withId:rhs];
    }
    else {
...
void OrgApacheCommonsLang3BuilderEqualsBuilder_reflectionAppendWithId_withId_withIOSClass_withOrgApacheCommonsLang3BuilderEqualsBuilder_withBoolean_withNSStringArray_(id lhs, id rhs, IOSClass *clazz, OrgApacheCommonsLang3BuilderEqualsBuilder *builder, jboolean useTransients, IOSObjectArray *excludeFields) {
  ...
  @try {
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(fields))->size_ && ((OrgApacheCommonsLang3BuilderEqualsBuilder *) nil_chk(builder))->isEquals_; i++) {
      ...
      if (!OrgApacheCommonsLang3ArrayUtils_containsWithNSObjectArray_withId_(excludeFields, [((JavaLangReflectField *) nil_chk(f)) getName]) && ![((NSString *) nil_chk([f getName])) java_contains:@"$"] && (useTransients || !JavaLangReflectModifier_isTransientWithInt_([f getModifiers])) && !JavaLangReflectModifier_isStaticWithInt_([f getModifiers]) && ![f isAnnotationPresentWithIOSClass:OrgApacheCommonsLang3BuilderEqualsExclude_class_()]) {
        @try {
          [((OrgApacheCommonsLang3BuilderEqualsBuilder *) nil_chk(builder)) appendWithId:[f getWithId:lhs] withId:[f getWithId:rhs]];
        }
        @catch (JavaLangIllegalAccessException *e) {
          @throw create_JavaLangInternalError_initWithNSString_(@"Unexpected IllegalAccessException");
        }
      }
    }
  }
...
void OrgApacheCommonsLang3BuilderEqualsBuilder_appendArrayWithId_withId_(OrgApacheCommonsLang3BuilderEqualsBuilder *self, id lhs, id rhs) {
  if ([nil_chk(lhs) java_getClass] != [nil_chk(rhs) java_getClass]) {
    [self setEqualsWithBoolean:false];
  }
  else if ([lhs isKindOfClass:[IOSLongArray class]]) {
    [self appendWithLongArray:(IOSLongArray *) cast_chk(lhs, [IOSLongArray class]) withLongArray:(IOSLongArray *) cast_chk(rhs, [IOSLongArray class])];
  }
  else if ([lhs isKindOfClass:[IOSIntArray class]]) {
    [self appendWithIntArray:(IOSIntArray *) cast_chk(lhs, [IOSIntArray class]) withIntArray:(IOSIntArray *) cast_chk(rhs, [IOSIntArray class])];
  }
  else if ([lhs isKindOfClass:[IOSShortArray class]]) {
    [self appendWithShortArray:(IOSShortArray *) cast_chk(lhs, [IOSShortArray class]) withShortArray:(IOSShortArray *) cast_chk(rhs, [IOSShortArray class])];
  }
  else if ([lhs isKindOfClass:[IOSCharArray class]]) {
    [self appendWithCharArray:(IOSCharArray *) cast_chk(lhs, [IOSCharArray class]) withCharArray:(IOSCharArray *) cast_chk(rhs, [IOSCharArray class])];
  }
  else if ([lhs isKindOfClass:[IOSByteArray class]]) {
    [self appendWithByteArray:(IOSByteArray *) cast_chk(lhs, [IOSByteArray class]) withByteArray:(IOSByteArray *) cast_chk(rhs, [IOSByteArray class])];
  }
  else if ([lhs isKindOfClass:[IOSDoubleArray class]]) {
    [self appendWithDoubleArray:(IOSDoubleArray *) cast_chk(lhs, [IOSDoubleArray class]) withDoubleArray:(IOSDoubleArray *) cast_chk(rhs, [IOSDoubleArray class])];
  }
  else if ([lhs isKindOfClass:[IOSFloatArray class]]) {
    [self appendWithFloatArray:(IOSFloatArray *) cast_chk(lhs, [IOSFloatArray class]) withFloatArray:(IOSFloatArray *) cast_chk(rhs, [IOSFloatArray class])];
  }
  else if ([lhs isKindOfClass:[IOSBooleanArray class]]) {
    [self appendWithBooleanArray:(IOSBooleanArray *) cast_chk(lhs, [IOSBooleanArray class]) withBooleanArray:(IOSBooleanArray *) cast_chk(rhs, [IOSBooleanArray class])];
  }
  else {
    [self appendWithNSObjectArray:(IOSObjectArray *) cast_check(lhs, IOSClass_arrayType(NSObject_class_(), 1)) withNSObjectArray:(IOSObjectArray *) cast_check(rhs, IOSClass_arrayType(NSObject_class_(), 1))];
  }
}
