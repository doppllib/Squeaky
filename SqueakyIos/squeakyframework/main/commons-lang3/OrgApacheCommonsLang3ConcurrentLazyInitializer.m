...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/concurrent/LazyInitializer.java
//

#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3ConcurrentLazyInitializer.h"
...
- (id)get {
  ...
  if (result == nil) {
    @synchronized(self) {
      result = JreLoadVolatileId(&object_);
      if (result == nil) {
        JreVolatileStrongAssign(&object_, result = [self initialize__]);
      }
    }
  }
  return result;
