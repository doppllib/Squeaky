...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/CharRange.java
//
...
inline jlong OrgApacheCommonsLang3CharRange_get_serialVersionUID();
...
- (jboolean)containsWithOrgApacheCommonsLang3CharRange:(OrgApacheCommonsLang3CharRange *)range {
  if (range == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"The Range must not be null");
  }
  if (negated_) {
    if (range->negated_) {
...
- (NSString *)description {
  if (iToString_ == nil) {
    ...
    [buf appendWithChar:start_];
    if (start_ != end_) {
      [buf appendWithChar:'-'];
      [buf appendWithChar:end_];
    }
    JreStrongAssign(&iToString_, [buf description]);
  }
  return iToString_;
}

- (id<JavaUtilIterator>)iterator {
  return create_OrgApacheCommonsLang3CharRange_CharacterIterator_initWithOrgApacheCommonsLang3CharRange_(self);
}
...
OrgApacheCommonsLang3CharRange *OrgApacheCommonsLang3CharRange_isWithChar_(jchar ch) {
  ...
  return create_OrgApacheCommonsLang3CharRange_initWithChar_withChar_withBoolean_(ch, ch, false);
}

OrgApacheCommonsLang3CharRange *OrgApacheCommonsLang3CharRange_isNotWithChar_(jchar ch) {
  OrgApacheCommonsLang3CharRange_initialize();
  return create_OrgApacheCommonsLang3CharRange_initWithChar_withChar_withBoolean_(ch, ch, true);
}

OrgApacheCommonsLang3CharRange *OrgApacheCommonsLang3CharRange_isInWithChar_withChar_(jchar start, jchar end) {
  OrgApacheCommonsLang3CharRange_initialize();
  return create_OrgApacheCommonsLang3CharRange_initWithChar_withChar_withBoolean_(start, end, false);
}

OrgApacheCommonsLang3CharRange *OrgApacheCommonsLang3CharRange_isNotInWithChar_withChar_(jchar start, jchar end) {
  OrgApacheCommonsLang3CharRange_initialize();
  return create_OrgApacheCommonsLang3CharRange_initWithChar_withChar_withBoolean_(start, end, true);
}
