...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/reflect/TypeUtils.java
//
...
__attribute__((unused)) static OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder *new_OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder *create_OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeBuilder_init();
...
inline IOSObjectArray *OrgApacheCommonsLang3ReflectTypeUtils_WildcardTypeImpl_get_EMPTY_BOUNDS();
...
jboolean OrgApacheCommonsLang3ReflectTypeUtils_isAssignableWithJavaLangReflectType_withJavaLangReflectParameterizedType_withJavaUtilMap_(id<JavaLangReflectType> type, id<JavaLangReflectParameterizedType> toParameterizedType, id<JavaUtilMap> typeVarAssigns) {
  ...
  for (id<JavaLangReflectTypeVariable> __strong var in nil_chk([((id<JavaUtilMap>) nil_chk(toTypeVarAssigns)) keySet])) {
    ...
    if (toTypeArg == nil && [fromTypeArg isKindOfClass:[IOSClass class]]) {
      continue;
    }
