...
+ (jboolean)withDecimalsParsingWithNSString:(NSString *)str
                                    withInt:(jint)beginIdx;
...
__attribute__((unused)) static jboolean OrgApacheCommonsLang3MathNumberUtils_withDecimalsParsingWithNSString_withInt_(NSString *str, jint beginIdx);

__attribute__((unused)) static IOSObjectArray *OrgApacheCommonsLang3MathNumberUtils__Annotations$0();
...
+ (jboolean)isCreatableWithNSString:(NSString *)str {
  return OrgApacheCommonsLang3MathNumberUtils_isCreatableWithNSString_(str);
}
...
+ (jboolean)withDecimalsParsingWithNSString:(NSString *)str
                                    withInt:(jint)beginIdx {
  return OrgApacheCommonsLang3MathNumberUtils_withDecimalsParsingWithNSString_withInt_(str, beginIdx);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "Z", 0x9, 40, 1, -1, -1, 41, -1 },
    { NULL, "Z", 0x9, 42, 1, -1, -1, -1, -1 },
    { NULL, "Z", 0x9, 43, 1, -1, -1, -1, -1 },
    { NULL, "Z", 0xa, 44, 2, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 45, 46, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 45, 47, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 45, 48, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 45, 49, -1, -1, -1, -1 },
  };
  ...
  methods[50].selector = @selector(isCreatableWithNSString:);
  methods[51].selector = @selector(isParsableWithNSString:);
  methods[52].selector = @selector(withDecimalsParsingWithNSString:withInt:);
  methods[53].selector = @selector(compareWithInt:withInt:);
  methods[54].selector = @selector(compareWithLong:withLong:);
  methods[55].selector = @selector(compareWithShort:withShort:);
  methods[56].selector = @selector(compareWithByte:withByte:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "LONG_ZERO", "LJavaLangLong;", .constantValue.asLong = 0, 0x19, -1, 50, -1, -1 },
    { "LONG_ONE", "LJavaLangLong;", .constantValue.asLong = 0, 0x19, -1, 51, -1, -1 },
    { "LONG_MINUS_ONE", "LJavaLangLong;", .constantValue.asLong = 0, 0x19, -1, 52, -1, -1 },
    { "INTEGER_ZERO", "LJavaLangInteger;", .constantValue.asLong = 0, 0x19, -1, 53, -1, -1 },
    { "INTEGER_ONE", "LJavaLangInteger;", .constantValue.asLong = 0, 0x19, -1, 54, -1, -1 },
    { "INTEGER_MINUS_ONE", "LJavaLangInteger;", .constantValue.asLong = 0, 0x19, -1, 55, -1, -1 },
    { "SHORT_ZERO", "LJavaLangShort;", .constantValue.asLong = 0, 0x19, -1, 56, -1, -1 },
    { "SHORT_ONE", "LJavaLangShort;", .constantValue.asLong = 0, 0x19, -1, 57, -1, -1 },
    { "SHORT_MINUS_ONE", "LJavaLangShort;", .constantValue.asLong = 0, 0x19, -1, 58, -1, -1 },
    { "BYTE_ZERO", "LJavaLangByte;", .constantValue.asLong = 0, 0x19, -1, 59, -1, -1 },
    { "BYTE_ONE", "LJavaLangByte;", .constantValue.asLong = 0, 0x19, -1, 60, -1, -1 },
    { "BYTE_MINUS_ONE", "LJavaLangByte;", .constantValue.asLong = 0, 0x19, -1, 61, -1, -1 },
    { "DOUBLE_ZERO", "LJavaLangDouble;", .constantValue.asLong = 0, 0x19, -1, 62, -1, -1 },
    { "DOUBLE_ONE", "LJavaLangDouble;", .constantValue.asLong = 0, 0x19, -1, 63, -1, -1 },
    { "DOUBLE_MINUS_ONE", "LJavaLangDouble;", .constantValue.asLong = 0, 0x19, -1, 64, -1, -1 },
    { "FLOAT_ZERO", "LJavaLangFloat;", .constantValue.asLong = 0, 0x19, -1, 65, -1, -1 },
    { "FLOAT_ONE", "LJavaLangFloat;", .constantValue.asLong = 0, 0x19, -1, 66, -1, -1 },
    { "FLOAT_MINUS_ONE", "LJavaLangFloat;", .constantValue.asLong = 0, 0x19, -1, 67, -1, -1 },
  };
  static const void *ptrTable[] = { "toInt", "LNSString;", "LNSString;I", "toLong", "LNSString;J", "toFloat", "LNSString;F", "toDouble", "LNSString;D", "toByte", "LNSString;B", "toShort", "LNSString;S", "createNumber", "LJavaLangNumberFormatException;", "getMantissa", "isAllZeros", "createFloat", "createDouble", "createInteger", "createLong", "createBigInteger", "createBigDecimal", "min", "[J", "[I", "[S", "[B", "[D", "[F", "max", "validateArray", "LNSObject;", "JJJ", "III", "SSS", "BBB", "DDD", "FFF", "isDigits", "isNumber", (void *)&OrgApacheCommonsLang3MathNumberUtils__Annotations$0, "isCreatable", "isParsable", "withDecimalsParsing", "compare", "II", "JJ", "SS", "BB", &OrgApacheCommonsLang3MathNumberUtils_LONG_ZERO, &OrgApacheCommonsLang3MathNumberUtils_LONG_ONE, &OrgApacheCommonsLang3MathNumberUtils_LONG_MINUS_ONE, &OrgApacheCommonsLang3MathNumberUtils_INTEGER_ZERO, &OrgApacheCommonsLang3MathNumberUtils_INTEGER_ONE, &OrgApacheCommonsLang3MathNumberUtils_INTEGER_MINUS_ONE, &OrgApacheCommonsLang3MathNumberUtils_SHORT_ZERO, &OrgApacheCommonsLang3MathNumberUtils_SHORT_ONE, &OrgApacheCommonsLang3MathNumberUtils_SHORT_MINUS_ONE, &OrgApacheCommonsLang3MathNumberUtils_BYTE_ZERO, &OrgApacheCommonsLang3MathNumberUtils_BYTE_ONE, &OrgApacheCommonsLang3MathNumberUtils_BYTE_MINUS_ONE, &OrgApacheCommonsLang3MathNumberUtils_DOUBLE_ZERO, &OrgApacheCommonsLang3MathNumberUtils_DOUBLE_ONE, &OrgApacheCommonsLang3MathNumberUtils_DOUBLE_MINUS_ONE, &OrgApacheCommonsLang3MathNumberUtils_FLOAT_ZERO, &OrgApacheCommonsLang3MathNumberUtils_FLOAT_ONE, &OrgApacheCommonsLang3MathNumberUtils_FLOAT_MINUS_ONE };
  static const J2ObjcClassInfo _OrgApacheCommonsLang3MathNumberUtils = { "NumberUtils", "org.apache.commons.lang3.math", ptrTable, methods, fields, 7, 0x1, 57, 18, -1, -1, -1, -1, -1 };
  return &_OrgApacheCommonsLang3MathNumberUtils;
}

+ (void)initialize {
  if (self == [OrgApacheCommonsLang3MathNumberUtils class]) {
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_LONG_ZERO, JavaLangLong_valueOfWithLong_(0LL));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_LONG_ONE, JavaLangLong_valueOfWithLong_(1LL));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_LONG_MINUS_ONE, JavaLangLong_valueOfWithLong_(-1LL));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_INTEGER_ZERO, JavaLangInteger_valueOfWithInt_(0));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_INTEGER_ONE, JavaLangInteger_valueOfWithInt_(1));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_INTEGER_MINUS_ONE, JavaLangInteger_valueOfWithInt_(-1));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_SHORT_ZERO, JavaLangShort_valueOfWithShort_((jshort) 0));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_SHORT_ONE, JavaLangShort_valueOfWithShort_((jshort) 1));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_SHORT_MINUS_ONE, JavaLangShort_valueOfWithShort_((jshort) -1));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_BYTE_ZERO, JavaLangByte_valueOfWithByte_((jbyte) 0));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_BYTE_ONE, JavaLangByte_valueOfWithByte_((jbyte) 1));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_BYTE_MINUS_ONE, JavaLangByte_valueOfWithByte_((jbyte) -1));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_DOUBLE_ZERO, JavaLangDouble_valueOfWithDouble_(0.0));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_DOUBLE_ONE, JavaLangDouble_valueOfWithDouble_(1.0));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_DOUBLE_MINUS_ONE, JavaLangDouble_valueOfWithDouble_(-1.0));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_FLOAT_ZERO, JavaLangFloat_valueOfWithFloat_(0.0f));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_FLOAT_ONE, JavaLangFloat_valueOfWithFloat_(1.0f));
    JreStrongAssign(&OrgApacheCommonsLang3MathNumberUtils_FLOAT_MINUS_ONE, JavaLangFloat_valueOfWithFloat_(-1.0f));
...
NSNumber *OrgApacheCommonsLang3MathNumberUtils_createNumberWithNSString_(NSString *str) {
  ...
  if (OrgApacheCommonsLang3StringUtils_isBlankWithJavaLangCharSequence_(str)) {
    @throw create_JavaLangNumberFormatException_initWithNSString_(@"A blank string is not a valid number");
  }
  IOSObjectArray *hex_prefixes = [IOSObjectArray arrayWithObjects:(id[]){ @"0x", @"0X", @"-0x", @"-0X", @"#", @"-#" } count:6 type:NSString_class_()];
  jint pfxLen = 0;
  {
    ...
    while (b__ < e__) {
      NSString *pfx = *b__++;
      if ([str hasPrefix:pfx]) {
        pfxLen += ((jint) [((NSString *) nil_chk(pfx)) length]);
        break;
      }
    }
  }
  if (pfxLen > 0) {
    ...
    for (jint i = pfxLen; i < ((jint) [str length]); i++) {
    ...
    jint hexDigits = ((jint) [str length]) - pfxLen;
  ...
  jchar lastChar = [str charAtWithInt:((jint) [str length]) - 1];
  NSString *mant;
  NSString *dec;
  NSString *exp;
  ...
  if (decPos > -1) {
    if (expPos > -1) {
      if (expPos < decPos || expPos > ((jint) [str length])) {
        @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$", str, @" is not a valid number."));
      }
  ...
  if (!JavaLangCharacter_isDigitWithChar_(lastChar) && lastChar != '.') {
    if (expPos > -1 && expPos < ((jint) [str length]) - 1) {
      exp = [str java_substring:expPos + 1 endIndex:((jint) [str length]) - 1];
    }
    else {
      exp = nil;
    }
    NSString *numeric = [str java_substring:0 endIndex:((jint) [str length]) - 1];
  ...
  if (expPos > -1 && expPos < ((jint) [str length]) - 1) {
    exp = [str java_substring:expPos + 1 endIndex:((jint) [str length])];
  }
  else {
    exp = nil;
  }
  ...
  @try {
    JavaLangFloat *f = OrgApacheCommonsLang3MathNumberUtils_createFloatWithNSString_(str);
    JavaLangDouble *d = OrgApacheCommonsLang3MathNumberUtils_createDoubleWithNSString_(str);
    if (![((JavaLangFloat *) nil_chk(f)) isInfinite] && !([f floatValue] == 0.0f && !allZeros) && [((NSString *) nil_chk([f description])) isEqual:[((JavaLangDouble *) nil_chk(d)) description]]) {
      return f;
    }
    if (![((JavaLangDouble *) nil_chk(d)) isInfinite] && !([d doubleValue] == 0.0 && !allZeros)) {
      JavaMathBigDecimal *b = OrgApacheCommonsLang3MathNumberUtils_createBigDecimalWithNSString_(str);
      if ([((JavaMathBigDecimal *) nil_chk(b)) compareToWithId:JavaMathBigDecimal_valueOfWithDouble_([d doubleValue])] == 0) {
        return d;
      }
      return b;
    }
...
NSString *OrgApacheCommonsLang3MathNumberUtils_getMantissaWithNSString_(NSString *str) {
  OrgApacheCommonsLang3MathNumberUtils_initialize();
  return OrgApacheCommonsLang3MathNumberUtils_getMantissaWithNSString_withInt_(str, ((jint) [((NSString *) nil_chk(str)) length]));
}
...
jboolean OrgApacheCommonsLang3MathNumberUtils_isAllZerosWithNSString_(NSString *str) {
  ...
  for (jint i = ((jint) [str length]) - 1; i >= 0; i--) {
    if ([str charAtWithInt:i] != '0') {
      return false;
    }
  }
  return ((jint) [str length]) > 0;
}
...
JavaMathBigInteger *OrgApacheCommonsLang3MathNumberUtils_createBigIntegerWithNSString_(NSString *str) {
  ...
  else if ([str java_hasPrefix:@"0" offset:pos] && ((jint) [str length]) > pos + 1) {
    radix = 8;
    pos++;
  }
  JavaMathBigInteger *value = create_JavaMathBigInteger_initWithNSString_withInt_([str java_substring:pos], radix);
...
JavaMathBigDecimal *OrgApacheCommonsLang3MathNumberUtils_createBigDecimalWithNSString_(NSString *str) {
  ...
  if ([((NSString *) nil_chk([str java_trim])) hasPrefix:@"--"]) {
    @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$", str, @" is not a valid number."));
  }
...
void OrgApacheCommonsLang3MathNumberUtils_validateArrayWithId_(id array) {
  ...
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(JavaLangReflectArray_getLengthWithId_(array) != 0, @"Array cannot be empty.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
}
...
jboolean OrgApacheCommonsLang3MathNumberUtils_isDigitsWithNSString_(NSString *str) {
  OrgApacheCommonsLang3MathNumberUtils_initialize();
  return OrgApacheCommonsLang3StringUtils_isNumericWithJavaLangCharSequence_(str);
}
...
jboolean OrgApacheCommonsLang3MathNumberUtils_isCreatableWithNSString_(NSString *str) {
  OrgApacheCommonsLang3MathNumberUtils_initialize();
  ...
  jint start = IOSCharArray_Get(chars, 0) == '-' || IOSCharArray_Get(chars, 0) == '+' ? 1 : 0;
  jboolean hasLeadingPlusSign = start == 1 && IOSCharArray_Get(chars, 0) == '+';
  ...
  if (i < chars->size_) {
    if (IOSCharArray_Get(chars, i) >= '0' && IOSCharArray_Get(chars, i) <= '9') {
      if (JreLoadStatic(OrgApacheCommonsLang3SystemUtils, IS_JAVA_1_6) && hasLeadingPlusSign && !hasDecPoint) {
        return false;
      }
      return true;
    }
...
jboolean OrgApacheCommonsLang3MathNumberUtils_isParsableWithNSString_(NSString *str) {
  ...
  if ([((NSString *) nil_chk(str)) charAtWithInt:((jint) [str length]) - 1] == '.') {
    return false;
  }
  if ([str charAtWithInt:0] == '-') {
    if (((jint) [str length]) == 1) {
      return false;
    }
    return OrgApacheCommonsLang3MathNumberUtils_withDecimalsParsingWithNSString_withInt_(str, 1);
  }
  else {
    return OrgApacheCommonsLang3MathNumberUtils_withDecimalsParsingWithNSString_withInt_(str, 0);
  }
}

jboolean OrgApacheCommonsLang3MathNumberUtils_withDecimalsParsingWithNSString_withInt_(NSString *str, jint beginIdx) {
  OrgApacheCommonsLang3MathNumberUtils_initialize();
  jint decimalPoints = 0;
  for (jint i = beginIdx; i < ((jint) [((NSString *) nil_chk(str)) length]); i++) {
    jboolean isDecimalPoint = [str charAtWithInt:i] == '.';
    if (isDecimalPoint) {
      decimalPoints++;
    }
    if (decimalPoints > 1) {
    ...
    if (!isDecimalPoint && !JavaLangCharacter_isDigitWithChar_([str charAtWithInt:i])) {
      return false;
    }
  }
  return true;
...
IOSObjectArray *OrgApacheCommonsLang3MathNumberUtils__Annotations$0() {
