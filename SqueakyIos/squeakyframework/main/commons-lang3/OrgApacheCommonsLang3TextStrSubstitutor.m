...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/text/StrSubstitutor.java
//
...
#include "OrgApacheCommonsLang3TextStrSubstitutor.h"
...
- (NSString *)replaceWithNSString:(NSString *)source {
  ...
  if ([self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:((jint) [source length])] == false) {
    return source;
  }
...
- (NSString *)replaceWithJavaLangStringBuffer:(JavaLangStringBuffer *)source {
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [create_OrgApacheCommonsLang3TextStrBuilder_initWithInt_([source length]) appendWithJavaLangStringBuffer:source];
  [self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:[((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) length]];
  return [buf description];
}
...
- (NSString *)replaceWithJavaLangCharSequence:(id<JavaLangCharSequence>)source {
  ...
  return [self replaceWithJavaLangCharSequence:source withInt:0 withInt:[source length]];
}
...
- (NSString *)replaceWithOrgApacheCommonsLang3TextStrBuilder:(OrgApacheCommonsLang3TextStrBuilder *)source {
  ...
  OrgApacheCommonsLang3TextStrBuilder *buf = [create_OrgApacheCommonsLang3TextStrBuilder_initWithInt_([source length]) appendWithOrgApacheCommonsLang3TextStrBuilder:source];
  [self substituteWithOrgApacheCommonsLang3TextStrBuilder:buf withInt:0 withInt:[((OrgApacheCommonsLang3TextStrBuilder *) nil_chk(buf)) length]];
  return [buf description];
}
...
- (jboolean)replaceInWithJavaLangStringBuffer:(JavaLangStringBuffer *)source {
  ...
  return [self replaceInWithJavaLangStringBuffer:source withInt:0 withInt:[source length]];
}
...
- (jboolean)replaceInWithJavaLangStringBuilder:(JavaLangStringBuilder *)source {
  ...
  return [self replaceInWithJavaLangStringBuilder:source withInt:0 withInt:[source length]];
}
...
- (jboolean)replaceInWithOrgApacheCommonsLang3TextStrBuilder:(OrgApacheCommonsLang3TextStrBuilder *)source {
  ...
  return [self substituteWithOrgApacheCommonsLang3TextStrBuilder:source withInt:0 withInt:[source length]];
}
...
- (jboolean)isPreserveEscapes {
  return preserveEscapes_;
}

- (void)setPreserveEscapesWithBoolean:(jboolean)preserveEscapes {
  self->preserveEscapes_ = preserveEscapes;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[53].selector = @selector(isPreserveEscapes);
  methods[54].selector = @selector(setPreserveEscapesWithBoolean:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "DEFAULT_ESCAPE", "C", .constantValue.asUnichar = OrgApacheCommonsLang3TextStrSubstitutor_DEFAULT_ESCAPE, 0x19, -1, -1, -1, -1 },
    { "DEFAULT_PREFIX", "LOrgApacheCommonsLang3TextStrMatcher;", .constantValue.asLong = 0, 0x19, -1, 61, -1, -1 },
    { "DEFAULT_SUFFIX", "LOrgApacheCommonsLang3TextStrMatcher;", .constantValue.asLong = 0, 0x19, -1, 62, -1, -1 },
    { "DEFAULT_VALUE_DELIMITER", "LOrgApacheCommonsLang3TextStrMatcher;", .constantValue.asLong = 0, 0x19, -1, 63, -1, -1 },
          ...
          if (endMatchLen == 0) {
            ...
            if (nestedVarCount == 0) {
              ...
              if (substitutionInVariablesEnabled) {
                ...
                [self substituteWithOrgApacheCommonsLang3TextStrBuilder:bufName withInt:0 withInt:[bufName length]];
              ...
              if (varValue != nil) {
                jint varLen = ((jint) [varValue length]);
