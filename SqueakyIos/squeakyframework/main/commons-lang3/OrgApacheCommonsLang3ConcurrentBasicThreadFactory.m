...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/concurrent/BasicThreadFactory.java
//

#include "IOSClass.h"
#include "IOSObjectArray.h"
#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3ConcurrentBasicThreadFactory.h"
...
- (void)dealloc {
  RELEASE_(threadCounter_);
  RELEASE_(wrappedFactory_);
  RELEASE_(uncaughtExceptionHandler_);
  RELEASE_(namingPattern_);
  RELEASE_(priority_);
  RELEASE_(daemonFlag_);
  [super dealloc];
}
...
void OrgApacheCommonsLang3ConcurrentBasicThreadFactory_initWithOrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder_(OrgApacheCommonsLang3ConcurrentBasicThreadFactory *self, OrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder *builder) {
  ...
  if (((OrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder *) nil_chk(builder))->wrappedFactory_ == nil) {
    JreStrongAssign(&self->wrappedFactory_, JavaUtilConcurrentExecutors_defaultThreadFactory());
  }
  else {
    JreStrongAssign(&self->wrappedFactory_, builder->wrappedFactory_);
  }
  JreStrongAssign(&self->namingPattern_, builder->namingPattern_);
  JreStrongAssign(&self->priority_, builder->priority_);
  JreStrongAssign(&self->daemonFlag_, builder->daemonFlag_);
  JreStrongAssign(&self->uncaughtExceptionHandler_, builder->exceptionHandler_);
  JreStrongAssignAndConsume(&self->threadCounter_, new_JavaUtilConcurrentAtomicAtomicLong_init());
}
...
void OrgApacheCommonsLang3ConcurrentBasicThreadFactory_initializeThreadWithJavaLangThread_(OrgApacheCommonsLang3ConcurrentBasicThreadFactory *self, JavaLangThread *t) {
  if (OrgApacheCommonsLang3ConcurrentBasicThreadFactory_getNamingPattern(self) != nil) {
    ...
    [((JavaLangThread *) nil_chk(t)) setNameWithNSString:NSString_java_formatWithNSString_withNSObjectArray_(OrgApacheCommonsLang3ConcurrentBasicThreadFactory_getNamingPattern(self), [IOSObjectArray arrayWithObjects:(id[]){ count } count:1 type:NSObject_class_()])];
  }
...
- (OrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder *)wrappedFactoryWithJavaUtilConcurrentThreadFactory:(id<JavaUtilConcurrentThreadFactory>)factory {
  if (factory == nil) {
    @throw create_JavaLangNullPointerException_initWithNSString_(@"Wrapped ThreadFactory must not be null!");
  }
  JreStrongAssign(&wrappedFactory_, factory);
  return self;
}

- (OrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder *)namingPatternWithNSString:(NSString *)pattern {
  if (pattern == nil) {
    @throw create_JavaLangNullPointerException_initWithNSString_(@"Naming pattern must not be null!");
  }
  JreStrongAssign(&namingPattern_, pattern);
  return self;
}

- (OrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder *)daemonWithBoolean:(jboolean)f {
  JreStrongAssign(&daemonFlag_, JavaLangBoolean_valueOfWithBoolean_(f));
  return self;
}

- (OrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder *)priorityWithInt:(jint)prio {
  JreStrongAssign(&priority_, JavaLangInteger_valueOfWithInt_(prio));
  return self;
}
...
- (OrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder *)uncaughtExceptionHandlerWithJavaLangThread_UncaughtExceptionHandler:(id<JavaLangThread_UncaughtExceptionHandler>)handler {
  if (handler == nil) {
    @throw create_JavaLangNullPointerException_initWithNSString_(@"Uncaught exception handler must not be null!");
  }
  JreStrongAssign(&exceptionHandler_, handler);
  return self;
}

- (void)reset {
  JreStrongAssign(&wrappedFactory_, nil);
  JreStrongAssign(&exceptionHandler_, nil);
  JreStrongAssign(&namingPattern_, nil);
  JreStrongAssign(&priority_, nil);
  JreStrongAssign(&daemonFlag_, nil);
}

- (OrgApacheCommonsLang3ConcurrentBasicThreadFactory *)build {
  OrgApacheCommonsLang3ConcurrentBasicThreadFactory *factory = create_OrgApacheCommonsLang3ConcurrentBasicThreadFactory_initWithOrgApacheCommonsLang3ConcurrentBasicThreadFactory_Builder_(self);
  [self reset];
  return factory;
}
