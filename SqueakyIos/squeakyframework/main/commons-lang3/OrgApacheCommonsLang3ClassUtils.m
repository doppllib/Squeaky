...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/ClassUtils.java
//
...
#include "OrgApacheCommonsLang3MutableMutableObject.h"
...
inline id<JavaUtilMap> OrgApacheCommonsLang3ClassUtils_get_namePrimitiveMap();
static id<JavaUtilMap> OrgApacheCommonsLang3ClassUtils_namePrimitiveMap;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgApacheCommonsLang3ClassUtils, namePrimitiveMap, id<JavaUtilMap>)
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "namePrimitiveMap", "LJavaUtilMap;", .constantValue.asLong = 0, 0x1a, -1, 67, 68, -1 },
    { "primitiveWrapperMap", "LJavaUtilMap;", .constantValue.asLong = 0, 0x1a, -1, 69, 70, -1 },
    { "wrapperPrimitiveMap", "LJavaUtilMap;", .constantValue.asLong = 0, 0x1a, -1, 71, 70, -1 },
    { "abbreviationMap", "LJavaUtilMap;", .constantValue.asLong = 0, 0x1a, -1, 72, 73, -1 },
    { "reverseAbbreviationMap", "LJavaUtilMap;", .constantValue.asLong = 0, 0x1a, -1, 74, 73, -1 },
  };
  static const void *ptrTable[] = { "getShortClassName", "LNSObject;LNSString;", "LIOSClass;", "(Ljava/lang/Class<*>;)Ljava/lang/String;", "LNSString;", "getSimpleName", "getPackageName", "getAbbreviatedName", "LIOSClass;I", "(Ljava/lang/Class<*>;I)Ljava/lang/String;", "LNSString;I", "getAllSuperclasses", "(Ljava/lang/Class<*>;)Ljava/util/List<Ljava/lang/Class<*>;>;", "getAllInterfaces", "LIOSClass;LJavaUtilHashSet;", "(Ljava/lang/Class<*>;Ljava/util/HashSet<Ljava/lang/Class<*>;>;)V", "convertClassNamesToClasses", "LJavaUtilList;", "(Ljava/util/List<Ljava/lang/String;>;)Ljava/util/List<Ljava/lang/Class<*>;>;", "convertClassesToClassNames", "(Ljava/util/List<Ljava/lang/Class<*>;>;)Ljava/util/List<Ljava/lang/String;>;", "isAssignable", "[LIOSClass;[LIOSClass;", "([Ljava/lang/Class<*>;[Ljava/lang/Class<*>;)Z", "[LIOSClass;[LIOSClass;Z", "([Ljava/lang/Class<*>;[Ljava/lang/Class<*>;Z)Z", "isPrimitiveOrWrapper", "(Ljava/lang/Class<*>;)Z", "isPrimitiveWrapper", "LIOSClass;LIOSClass;", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;)Z", "LIOSClass;LIOSClass;Z", "(Ljava/lang/Class<*>;Ljava/lang/Class<*>;Z)Z", "primitiveToWrapper", "(Ljava/lang/Class<*>;)Ljava/lang/Class<*>;", "primitivesToWrappers", "[LIOSClass;", "([Ljava/lang/Class<*>;)[Ljava/lang/Class<*>;", "wrapperToPrimitive", "wrappersToPrimitives", "isInnerClass", "getClass", "LJavaLangClassLoader;LNSString;Z", "LJavaLangClassNotFoundException;", "(Ljava/lang/ClassLoader;Ljava/lang/String;Z)Ljava/lang/Class<*>;", "LJavaLangClassLoader;LNSString;", "(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Class<*>;", "(Ljava/lang/String;)Ljava/lang/Class<*>;", "LNSString;Z", "(Ljava/lang/String;Z)Ljava/lang/Class<*>;", "getPublicMethod", "LIOSClass;LNSString;[LIOSClass;", "LJavaLangSecurityException;LJavaLangNoSuchMethodException;", "(Ljava/lang/Class<*>;Ljava/lang/String;[Ljava/lang/Class<*>;)Ljava/lang/reflect/Method;", "toCanonicalName", "toClass", "[LNSObject;", "([Ljava/lang/Object;)[Ljava/lang/Class<*>;", "getShortCanonicalName", "getPackageCanonicalName", "getCanonicalName", "hierarchy", "(Ljava/lang/Class<*>;)Ljava/lang/Iterable<Ljava/lang/Class<*>;>;", "LIOSClass;LOrgApacheCommonsLang3ClassUtils_Interfaces;", "(Ljava/lang/Class<*>;Lorg/apache/commons/lang3/ClassUtils$Interfaces;)Ljava/lang/Iterable<Ljava/lang/Class<*>;>;", &OrgApacheCommonsLang3ClassUtils_PACKAGE_SEPARATOR, &OrgApacheCommonsLang3ClassUtils_INNER_CLASS_SEPARATOR, &OrgApacheCommonsLang3ClassUtils_namePrimitiveMap, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Class<*>;>;", &OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap, "Ljava/util/Map<Ljava/lang/Class<*>;Ljava/lang/Class<*>;>;", &OrgApacheCommonsLang3ClassUtils_wrapperPrimitiveMap, &OrgApacheCommonsLang3ClassUtils_abbreviationMap, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;", &OrgApacheCommonsLang3ClassUtils_reverseAbbreviationMap, "LOrgApacheCommonsLang3ClassUtils_Interfaces;" };
  static const J2ObjcClassInfo _OrgApacheCommonsLang3ClassUtils = { "ClassUtils", "org.apache.commons.lang3", ptrTable, methods, fields, 7, 0x1, 43, 9, -1, 75, -1, -1, -1 };
  return &_OrgApacheCommonsLang3ClassUtils;
}

+ (void)initialize {
  if (self == [OrgApacheCommonsLang3ClassUtils class]) {
    JreStrongAssign(&OrgApacheCommonsLang3ClassUtils_PACKAGE_SEPARATOR, NSString_java_valueOfChar_(OrgApacheCommonsLang3ClassUtils_PACKAGE_SEPARATOR_CHAR));
    JreStrongAssign(&OrgApacheCommonsLang3ClassUtils_INNER_CLASS_SEPARATOR, NSString_java_valueOfChar_(OrgApacheCommonsLang3ClassUtils_INNER_CLASS_SEPARATOR_CHAR));
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3ClassUtils_namePrimitiveMap, new_JavaUtilHashMap_init());
    {
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"boolean" withId:JreLoadStatic(JavaLangBoolean, TYPE)];
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"byte" withId:JreLoadStatic(JavaLangByte, TYPE)];
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"char" withId:JreLoadStatic(JavaLangCharacter, TYPE)];
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"short" withId:JreLoadStatic(JavaLangShort, TYPE)];
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"int" withId:JreLoadStatic(JavaLangInteger, TYPE)];
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"long" withId:JreLoadStatic(JavaLangLong, TYPE)];
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"double" withId:JreLoadStatic(JavaLangDouble, TYPE)];
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"float" withId:JreLoadStatic(JavaLangFloat, TYPE)];
      [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap putWithId:@"void" withId:JreLoadStatic(JavaLangVoid, TYPE)];
    }
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap, new_JavaUtilHashMap_init());
    {
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangBoolean, TYPE) withId:JavaLangBoolean_class_()];
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangByte, TYPE) withId:JavaLangByte_class_()];
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangCharacter, TYPE) withId:JavaLangCharacter_class_()];
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangShort, TYPE) withId:JavaLangShort_class_()];
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangInteger, TYPE) withId:JavaLangInteger_class_()];
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangLong, TYPE) withId:JavaLangLong_class_()];
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangDouble, TYPE) withId:JavaLangDouble_class_()];
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangFloat, TYPE) withId:JavaLangFloat_class_()];
      [OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap putWithId:JreLoadStatic(JavaLangVoid, TYPE) withId:JreLoadStatic(JavaLangVoid, TYPE)];
    }
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3ClassUtils_wrapperPrimitiveMap, new_JavaUtilHashMap_init());
    {
      for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([OrgApacheCommonsLang3ClassUtils_primitiveWrapperMap entrySet])) {
        IOSClass *primitiveClass = [((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey];
        IOSClass *wrapperClass = [entry_ getValue];
        if (![((IOSClass *) nil_chk(primitiveClass)) isEqual:wrapperClass]) {
          [OrgApacheCommonsLang3ClassUtils_wrapperPrimitiveMap putWithId:wrapperClass withId:primitiveClass];
        }
      }
    }
    {
      id<JavaUtilMap> m = create_JavaUtilHashMap_init();
      [m putWithId:@"int" withId:@"I"];
      [m putWithId:@"boolean" withId:@"Z"];
      [m putWithId:@"float" withId:@"F"];
      [m putWithId:@"long" withId:@"J"];
      [m putWithId:@"short" withId:@"S"];
      [m putWithId:@"byte" withId:@"B"];
      [m putWithId:@"double" withId:@"D"];
      [m putWithId:@"char" withId:@"C"];
      id<JavaUtilMap> r = create_JavaUtilHashMap_init();
      for (id<JavaUtilMap_Entry> __strong e in nil_chk([m entrySet])) {
        [r putWithId:[((id<JavaUtilMap_Entry>) nil_chk(e)) getValue] withId:[e getKey]];
      }
      JreStrongAssign(&OrgApacheCommonsLang3ClassUtils_abbreviationMap, JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(m));
      JreStrongAssign(&OrgApacheCommonsLang3ClassUtils_reverseAbbreviationMap, JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(r));
    }
...
NSString *OrgApacheCommonsLang3ClassUtils_getShortClassNameWithNSString_(NSString *className_) {
  ...
  JavaLangStringBuilder *arrayPrefix = create_JavaLangStringBuilder_init();
  if ([((NSString *) nil_chk(className_)) hasPrefix:@"["]) {
    while ([((NSString *) nil_chk(className_)) charAtWithInt:0] == '[') {
      className_ = [className_ java_substring:1];
      [arrayPrefix appendWithNSString:@"[]"];
    }
    if ([className_ charAtWithInt:0] == 'L' && [className_ charAtWithInt:((jint) [className_ length]) - 1] == ';') {
      className_ = [className_ java_substring:1 endIndex:((jint) [className_ length]) - 1];
    }
...
NSString *OrgApacheCommonsLang3ClassUtils_getAbbreviatedNameWithNSString_withInt_(NSString *className_, jint len) {
  OrgApacheCommonsLang3ClassUtils_initialize();
  if (len <= 0) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"len must be > 0");
  }
  if (className_ == nil) {
    return OrgApacheCommonsLang3StringUtils_EMPTY;
  }
  ...
  IOSObjectArray *output = [IOSObjectArray arrayWithLength:packageLevels + 1 type:NSString_class_()];
  jint endIndex = ((jint) [className_ length]) - 1;
  for (jint level = packageLevels; level >= 0; level--) {
    ...
    availableSpace -= ((jint) [((NSString *) nil_chk(part)) length]);
    if (level > 0) {
      availableSpace--;
    }
    if (level == packageLevels) {
      IOSObjectArray_Set(output, level, part);
    }
    else {
      if (availableSpace > 0) {
        IOSObjectArray_Set(output, level, part);
        ...
        IOSObjectArray_Set(output, level, [part java_substring:0 endIndex:1]);
      }
    }
...
id<JavaUtilList> OrgApacheCommonsLang3ClassUtils_convertClassNamesToClassesWithJavaUtilList_(id<JavaUtilList> classNames) {
  ...
  id<JavaUtilList> classes = create_JavaUtilArrayList_initWithInt_([classNames size]);
...
id<JavaUtilList> OrgApacheCommonsLang3ClassUtils_convertClassesToClassNamesWithJavaUtilList_(id<JavaUtilList> classes) {
  ...
  id<JavaUtilList> classNames = create_JavaUtilArrayList_initWithInt_([classes size]);
...
IOSObjectArray *OrgApacheCommonsLang3ClassUtils_primitivesToWrappersWithIOSClassArray_(IOSObjectArray *classes) {
  ...
  IOSObjectArray *convertedClasses = [IOSObjectArray arrayWithLength:classes->size_ type:IOSClass_class_()];
  for (jint i = 0; i < classes->size_; i++) {
    IOSObjectArray_Set(convertedClasses, i, OrgApacheCommonsLang3ClassUtils_primitiveToWrapperWithIOSClass_(IOSObjectArray_Get(classes, i)));
  }
...
IOSObjectArray *OrgApacheCommonsLang3ClassUtils_wrappersToPrimitivesWithIOSClassArray_(IOSObjectArray *classes) {
  ...
  IOSObjectArray *convertedClasses = [IOSObjectArray arrayWithLength:classes->size_ type:IOSClass_class_()];
  for (jint i = 0; i < classes->size_; i++) {
    IOSObjectArray_Set(convertedClasses, i, OrgApacheCommonsLang3ClassUtils_wrapperToPrimitiveWithIOSClass_(IOSObjectArray_Get(classes, i)));
  }
  return convertedClasses;
}
...
IOSClass *OrgApacheCommonsLang3ClassUtils_getClassWithJavaLangClassLoader_withNSString_withBoolean_(JavaLangClassLoader *classLoader, NSString *className_, jboolean initialize_) {
  ...
  @try {
    IOSClass *clazz;
    if ([((id<JavaUtilMap>) nil_chk(OrgApacheCommonsLang3ClassUtils_namePrimitiveMap)) containsKeyWithId:className_]) {
      clazz = [OrgApacheCommonsLang3ClassUtils_namePrimitiveMap getWithId:className_];
    }
    else {
...
JavaLangReflectMethod *OrgApacheCommonsLang3ClassUtils_getPublicMethodWithIOSClass_withNSString_withIOSClassArray_(IOSClass *cls, NSString *methodName, IOSObjectArray *parameterTypes) {
  ...
  id<JavaUtilList> candidateClasses = create_JavaUtilArrayList_init();
  ...
  @throw create_JavaLangNoSuchMethodException_initWithNSString_(JreStrcat("$$C$", @"Can't find a public method for ", methodName, ' ', OrgApacheCommonsLang3ArrayUtils_toStringWithId_(parameterTypes)));
}
...
NSString *OrgApacheCommonsLang3ClassUtils_toCanonicalNameWithNSString_(NSString *className_) {
  ...
  if (className_ == nil) {
    @throw create_JavaLangNullPointerException_initWithNSString_(@"className must not be null.");
  }
  else if ([className_ hasSuffix:@"[]"]) {
    JavaLangStringBuilder *classNameBuffer = create_JavaLangStringBuilder_init();
    while ([((NSString *) nil_chk(className_)) hasSuffix:@"[]"]) {
      className_ = [className_ java_substring:0 endIndex:((jint) [className_ length]) - 2];
      [classNameBuffer appendWithNSString:@"["];
    }
    NSString *abbreviation = [((id<JavaUtilMap>) nil_chk(OrgApacheCommonsLang3ClassUtils_abbreviationMap)) getWithId:className_];
    if (abbreviation != nil) {
      [classNameBuffer appendWithNSString:abbreviation];
    }
    else {
      [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([classNameBuffer appendWithNSString:@"L"])) appendWithNSString:className_])) appendWithNSString:@";"];
    }
...
IOSObjectArray *OrgApacheCommonsLang3ClassUtils_toClassWithNSObjectArray_(IOSObjectArray *array) {
  ...
  IOSObjectArray *classes = [IOSObjectArray arrayWithLength:array->size_ type:IOSClass_class_()];
  for (jint i = 0; i < array->size_; i++) {
    IOSObjectArray_Set(classes, i, IOSObjectArray_Get(array, i) == nil ? nil : [nil_chk(IOSObjectArray_Get(array, i)) java_getClass]);
  }
  return classes;
}
...
NSString *OrgApacheCommonsLang3ClassUtils_getCanonicalNameWithNSString_(NSString *className_) {
  ...
  jint dim = 0;
  while ([((NSString *) nil_chk(className_)) hasPrefix:@"["]) {
    dim++;
    className_ = [className_ java_substring:1];
  }
  if (dim < 1) {
  ...
  if ([className_ hasPrefix:@"L"]) {
    className_ = [className_ java_substring:1 endIndex:[className_ hasSuffix:@";"] ? ((jint) [className_ length]) - 1 : ((jint) [className_ length])];
  }
  else {
    if (((jint) [className_ length]) > 0) {
  ...
  JavaLangStringBuilder *canonicalClassNameBuffer = create_JavaLangStringBuilder_initWithNSString_(className_);
  for (jint i = 0; i < dim; i++) {
    [canonicalClassNameBuffer appendWithNSString:@"[]"];
  }
...
id<JavaLangIterable> OrgApacheCommonsLang3ClassUtils_hierarchyWithIOSClass_withOrgApacheCommonsLang3ClassUtils_Interfaces_(IOSClass *type, OrgApacheCommonsLang3ClassUtils_Interfaces *interfacesBehavior) {
  OrgApacheCommonsLang3ClassUtils_initialize();
  id<JavaLangIterable> classes = create_OrgApacheCommonsLang3ClassUtils_1_initWithIOSClass_(type);
  if (interfacesBehavior != JreLoadEnum(OrgApacheCommonsLang3ClassUtils_Interfaces, INCLUDE)) {
    return classes;
  }
  return create_OrgApacheCommonsLang3ClassUtils_2_initWithJavaLangIterable_(classes);
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3ClassUtils_Interfaces class]) {
    ...
    for (jint i = 0; i < 2; i++) {
      (OrgApacheCommonsLang3ClassUtils_Interfaces_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      OrgApacheCommonsLang3ClassUtils_Interfaces_initWithNSString_withInt_(e, names[i], i);
    }
...
- (id<JavaUtilIterator>)iterator {
  OrgApacheCommonsLang3MutableMutableObject *next = create_OrgApacheCommonsLang3MutableMutableObject_initWithId_(val$type_);
  return create_OrgApacheCommonsLang3ClassUtils_1_1_initWithOrgApacheCommonsLang3MutableMutableObject_(next);
}
...
- (id<JavaUtilIterator>)iterator {
  id<JavaUtilSet> seenInterfaces = create_JavaUtilHashSet_init();
  id<JavaUtilIterator> wrapped = [((id<JavaLangIterable>) nil_chk(val$classes_)) iterator];
  return create_OrgApacheCommonsLang3ClassUtils_2_1_initWithJavaUtilIterator_withJavaUtilSet_(wrapped, seenInterfaces);
}
...
void OrgApacheCommonsLang3ClassUtils_2_initWithJavaLangIterable_(OrgApacheCommonsLang3ClassUtils_2 *self, id<JavaLangIterable> capture$0) {
  JreStrongAssign(&self->val$classes_, capture$0);
  NSObject_init(self);
}
...
- (IOSClass *)next {
  ...
  id<JavaUtilSet> currentInterfaces = create_JavaUtilLinkedHashSet_init();
  OrgApacheCommonsLang3ClassUtils_2_1_walkInterfacesWithJavaUtilSet_withIOSClass_(self, currentInterfaces, nextSuperclass);
  JreStrongAssign(&interfaces_, [currentInterfaces iterator]);
...
void OrgApacheCommonsLang3ClassUtils_2_1_initWithJavaUtilIterator_withJavaUtilSet_(OrgApacheCommonsLang3ClassUtils_2_1 *self, id<JavaUtilIterator> capture$0, id<JavaUtilSet> capture$1) {
  ...
  JreStrongAssign(&self->val$seenInterfaces_, capture$1);
  NSObject_init(self);
  JreStrongAssign(&self->interfaces_, [((id<JavaUtilSet>) nil_chk(JavaUtilCollections_emptySet())) iterator]);
}
