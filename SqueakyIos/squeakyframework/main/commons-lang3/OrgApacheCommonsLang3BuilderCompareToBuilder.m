...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/builder/CompareToBuilder.java
//
...
#include "OrgApacheCommonsLang3BuilderCompareToBuilder.h"
...
__attribute__((unused)) static void OrgApacheCommonsLang3BuilderCompareToBuilder_appendArrayWithId_withId_withJavaUtilComparator_(OrgApacheCommonsLang3BuilderCompareToBuilder *self, id lhs, id rhs, id<JavaUtilComparator> comparator);
...
- (OrgApacheCommonsLang3BuilderCompareToBuilder *)appendWithId:(id)lhs
  ...
  if ([[lhs java_getClass] isArray]) {
    OrgApacheCommonsLang3BuilderCompareToBuilder_appendArrayWithId_withId_withJavaUtilComparator_(self, lhs, rhs, comparator);
  }
  else {
    if (comparator == nil) {
...
- (OrgApacheCommonsLang3BuilderCompareToBuilder *)appendWithNSObjectArray:(IOSObjectArray *)lhs
  ...
  for (jint i = 0; i < lhs->size_ && comparison_ == 0; i++) {
    [self appendWithId:IOSObjectArray_Get(lhs, i) withId:IOSObjectArray_Get(rhs, i) withJavaUtilComparator:comparator];
  }
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LOrgApacheCommonsLang3BuilderCompareToBuilder;", 0x1, 13, 25, -1, -1, -1, -1 },
    { NULL, "LOrgApacheCommonsLang3BuilderCompareToBuilder;", 0x1, 13, 26, -1, -1, -1, -1 },
    { NULL, "LOrgApacheCommonsLang3BuilderCompareToBuilder;", 0x1, 13, 27, -1, 28, -1, -1 },
    ...
    { NULL, "LOrgApacheCommonsLang3BuilderCompareToBuilder;", 0x1, 13, 35, -1, -1, -1, -1 },
    { NULL, "LOrgApacheCommonsLang3BuilderCompareToBuilder;", 0x1, 13, 36, -1, -1, -1, -1 },
  ...
  methods[10].selector = @selector(appendArrayWithId:withId:withJavaUtilComparator:);
  methods[11].selector = @selector(appendWithLong:withLong:);
  methods[12].selector = @selector(appendWithInt:withInt:);
  methods[13].selector = @selector(appendWithShort:withShort:);
  methods[14].selector = @selector(appendWithChar:withChar:);
  methods[15].selector = @selector(appendWithByte:withByte:);
  methods[16].selector = @selector(appendWithDouble:withDouble:);
  methods[17].selector = @selector(appendWithFloat:withFloat:);
  methods[18].selector = @selector(appendWithBoolean:withBoolean:);
  methods[19].selector = @selector(appendWithNSObjectArray:withNSObjectArray:);
  methods[20].selector = @selector(appendWithNSObjectArray:withNSObjectArray:withJavaUtilComparator:);
  methods[21].selector = @selector(appendWithLongArray:withLongArray:);
  methods[22].selector = @selector(appendWithIntArray:withIntArray:);
  methods[23].selector = @selector(appendWithShortArray:withShortArray:);
  methods[24].selector = @selector(appendWithCharArray:withCharArray:);
  methods[25].selector = @selector(appendWithByteArray:withByteArray:);
  methods[26].selector = @selector(appendWithDoubleArray:withDoubleArray:);
  methods[27].selector = @selector(appendWithFloatArray:withFloatArray:);
  methods[28].selector = @selector(appendWithBooleanArray:withBooleanArray:);
  methods[29].selector = @selector(toComparison);
  methods[30].selector = @selector(build);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "comparison_", "I", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "reflectionCompare", "LNSObject;LNSObject;", "LNSObject;LNSObject;Z", "LNSObject;LNSObject;LJavaUtilCollection;", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/Collection<Ljava/lang/String;>;)I", "LNSObject;LNSObject;[LNSString;", "LNSObject;LNSObject;ZLIOSClass;[LNSString;", "(Ljava/lang/Object;Ljava/lang/Object;ZLjava/lang/Class<*>;[Ljava/lang/String;)I", "reflectionAppend", "LNSObject;LNSObject;LIOSClass;LOrgApacheCommonsLang3BuilderCompareToBuilder;Z[LNSString;", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Class<*>;Lorg/apache/commons/lang3/builder/CompareToBuilder;Z[Ljava/lang/String;)V", "appendSuper", "I", "append", "LNSObject;LNSObject;LJavaUtilComparator;", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/Comparator<*>;)Lorg/apache/commons/lang3/builder/CompareToBuilder;", "appendArray", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/Comparator<*>;)V", "JJ", "II", "SS", "CC", "BB", "DD", "FF", "ZZ", "[LNSObject;[LNSObject;", "[LNSObject;[LNSObject;LJavaUtilComparator;", "([Ljava/lang/Object;[Ljava/lang/Object;Ljava/util/Comparator<*>;)Lorg/apache/commons/lang3/builder/CompareToBuilder;", "[J[J", "[I[I", "[S[S", "[C[C", "[B[B", "[D[D", "[F[F", "[Z[Z", "Ljava/lang/Object;Lorg/apache/commons/lang3/builder/Builder<Ljava/lang/Integer;>;" };
  static const J2ObjcClassInfo _OrgApacheCommonsLang3BuilderCompareToBuilder = { "CompareToBuilder", "org.apache.commons.lang3.builder", ptrTable, methods, fields, 7, 0x1, 31, 1, -1, -1, -1, 37, -1 };
...
jint OrgApacheCommonsLang3BuilderCompareToBuilder_reflectionCompareWithId_withId_(id lhs, id rhs) {
  ...
  return OrgApacheCommonsLang3BuilderCompareToBuilder_reflectionCompareWithId_withId_withBoolean_withIOSClass_withNSStringArray_(lhs, rhs, false, nil, [IOSObjectArray arrayWithLength:0 type:NSString_class_()]);
}
...
jint OrgApacheCommonsLang3BuilderCompareToBuilder_reflectionCompareWithId_withId_withBoolean_(id lhs, id rhs, jboolean compareTransients) {
  OrgApacheCommonsLang3BuilderCompareToBuilder_initialize();
  return OrgApacheCommonsLang3BuilderCompareToBuilder_reflectionCompareWithId_withId_withBoolean_withIOSClass_withNSStringArray_(lhs, rhs, compareTransients, nil, [IOSObjectArray arrayWithLength:0 type:NSString_class_()]);
}
...
jint OrgApacheCommonsLang3BuilderCompareToBuilder_reflectionCompareWithId_withId_withBoolean_withIOSClass_withNSStringArray_(id lhs, id rhs, jboolean compareTransients, IOSClass *reflectUpToClass, IOSObjectArray *excludeFields) {
  ...
  if (![lhsClazz isInstance:rhs]) {
    @throw create_JavaLangClassCastException_init();
  }
  OrgApacheCommonsLang3BuilderCompareToBuilder *compareToBuilder = create_OrgApacheCommonsLang3BuilderCompareToBuilder_init();
...
void OrgApacheCommonsLang3BuilderCompareToBuilder_reflectionAppendWithId_withId_withIOSClass_withOrgApacheCommonsLang3BuilderCompareToBuilder_withBoolean_withNSStringArray_(id lhs, id rhs, IOSClass *clazz, OrgApacheCommonsLang3BuilderCompareToBuilder *builder, jboolean useTransients, IOSObjectArray *excludeFields) {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(fields))->size_ && ((OrgApacheCommonsLang3BuilderCompareToBuilder *) nil_chk(builder))->comparison_ == 0; i++) {
    ...
    if (!OrgApacheCommonsLang3ArrayUtils_containsWithNSObjectArray_withId_(excludeFields, [((JavaLangReflectField *) nil_chk(f)) getName]) && ![((NSString *) nil_chk([f getName])) java_contains:@"$"] && (useTransients || !JavaLangReflectModifier_isTransientWithInt_([f getModifiers])) && !JavaLangReflectModifier_isStaticWithInt_([f getModifiers])) {
      @try {
        [((OrgApacheCommonsLang3BuilderCompareToBuilder *) nil_chk(builder)) appendWithId:[f getWithId:lhs] withId:[f getWithId:rhs]];
      }
...
void OrgApacheCommonsLang3BuilderCompareToBuilder_appendArrayWithId_withId_withJavaUtilComparator_(OrgApacheCommonsLang3BuilderCompareToBuilder *self, id lhs, id rhs, id<JavaUtilComparator> comparator) {
  if ([lhs isKindOfClass:[IOSLongArray class]]) {
    ...
    [self appendWithNSObjectArray:(IOSObjectArray *) cast_check(lhs, IOSClass_arrayType(NSObject_class_(), 1)) withNSObjectArray:(IOSObjectArray *) cast_check(rhs, IOSClass_arrayType(NSObject_class_(), 1)) withJavaUtilComparator:comparator];
  }
}
