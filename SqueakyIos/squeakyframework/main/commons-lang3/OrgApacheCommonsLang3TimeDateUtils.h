...
FOUNDATION_EXPORT JavaUtilCalendar *OrgApacheCommonsLang3TimeDateUtils_toCalendarWithJavaUtilDate_withJavaUtilTimeZone_(JavaUtilDate *date, JavaUtilTimeZone *tz);
