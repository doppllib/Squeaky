...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/concurrent/BackgroundInitializer.java
//
...
- (jboolean)start {
  @synchronized(self) {
    if (![self isStarted]) {
      ...
      JreStrongAssign(&executor_, OrgApacheCommonsLang3ConcurrentBackgroundInitializer_getExternalExecutor(self));
      if (executor_ == nil) {
        JreStrongAssign(&executor_, tempExec = OrgApacheCommonsLang3ConcurrentBackgroundInitializer_createExecutor(self));
      }
      else {
        tempExec = nil;
      }
      JreStrongAssign(&future_, [executor_ submitWithJavaUtilConcurrentCallable:OrgApacheCommonsLang3ConcurrentBackgroundInitializer_createTaskWithJavaUtilConcurrentExecutorService_(self, tempExec)]);
      return true;
    }
    return false;
  }
...
- (id)get {
  ...
  @catch (JavaLangInterruptedException *iex) {
    ...
    @throw create_OrgApacheCommonsLang3ConcurrentConcurrentException_initWithNSException_(iex);
  }
}
...
- (id<JavaUtilConcurrentFuture>)getFuture {
  @synchronized(self) {
    if (future_ == nil) {
      @throw create_JavaLangIllegalStateException_initWithNSString_(@"start() must be called first!");
    }
    return future_;
  }
}
...
void OrgApacheCommonsLang3ConcurrentBackgroundInitializer_setExternalExecutorWithJavaUtilConcurrentExecutorService_(OrgApacheCommonsLang3ConcurrentBackgroundInitializer *self, id<JavaUtilConcurrentExecutorService> externalExecutor) {
  @synchronized(self) {
    if ([self isStarted]) {
      @throw create_JavaLangIllegalStateException_initWithNSString_(@"Cannot set ExecutorService after start()!");
    }
    JreStrongAssign(&self->externalExecutor_, externalExecutor);
  }
}
...
id<JavaUtilConcurrentCallable> OrgApacheCommonsLang3ConcurrentBackgroundInitializer_createTaskWithJavaUtilConcurrentExecutorService_(OrgApacheCommonsLang3ConcurrentBackgroundInitializer *self, id<JavaUtilConcurrentExecutorService> execDestroy) {
  return create_OrgApacheCommonsLang3ConcurrentBackgroundInitializer_InitializationTask_initWithOrgApacheCommonsLang3ConcurrentBackgroundInitializer_withJavaUtilConcurrentExecutorService_(self, execDestroy);
}
...
void OrgApacheCommonsLang3ConcurrentBackgroundInitializer_InitializationTask_initWithOrgApacheCommonsLang3ConcurrentBackgroundInitializer_withJavaUtilConcurrentExecutorService_(OrgApacheCommonsLang3ConcurrentBackgroundInitializer_InitializationTask *self, OrgApacheCommonsLang3ConcurrentBackgroundInitializer *outer$, id<JavaUtilConcurrentExecutorService> exec) {
  ...
  NSObject_init(self);
  JreStrongAssign(&self->execFinally_, exec);
}
