...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/Range.java
//

#include "IOSClass.h"
#include "IOSObjectArray.h"
#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3Range.h"
...
- (jint)elementCompareToWithId:(id)element {
  if (element == nil) {
    @throw create_JavaLangNullPointerException_initWithNSString_(@"Element is null");
  }
...
- (OrgApacheCommonsLang3Range *)intersectionWithWithOrgApacheCommonsLang3Range:(OrgApacheCommonsLang3Range *)other {
  if (![self isOverlappedByWithOrgApacheCommonsLang3Range:other]) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(NSString_java_formatWithNSString_withNSObjectArray_(@"Cannot calculate intersection with non-overlapping range %s", [IOSObjectArray arrayWithObjects:(id[]){ other } count:1 type:NSObject_class_()]));
  }
...
- (NSString *)description {
  if (toString_ == nil) {
    JreStrongAssign(&toString_, JreStrcat("C@$@C", '[', minimum_, @"..", maximum_, ']'));
  }
  return toString_;
}

- (NSString *)toStringWithNSString:(NSString *)format {
  return NSString_java_formatWithNSString_withNSObjectArray_(format, [IOSObjectArray arrayWithObjects:(id[]){ minimum_, maximum_, comparator_ } count:3 type:NSObject_class_()]);
}
...
OrgApacheCommonsLang3Range *OrgApacheCommonsLang3Range_betweenWithId_withId_withJavaUtilComparator_(id fromInclusive, id toInclusive, id<JavaUtilComparator> comparator) {
  OrgApacheCommonsLang3Range_initialize();
  return create_OrgApacheCommonsLang3Range_initWithId_withId_withJavaUtilComparator_(fromInclusive, toInclusive, comparator);
}
...
void OrgApacheCommonsLang3Range_initWithId_withId_withJavaUtilComparator_(OrgApacheCommonsLang3Range *self, id element1, id element2, id<JavaUtilComparator> comp) {
  ...
  if (element1 == nil || element2 == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$@", @"Elements in a range must not be null: element1=", element1, @", element2=", element2));
  }
  if (comp == nil) {
    JreStrongAssign(&self->comparator_, JreLoadEnum(OrgApacheCommonsLang3Range_ComparableComparator, INSTANCE));
  }
  else {
    JreStrongAssign(&self->comparator_, comp);
  }
  if ([((id<JavaUtilComparator>) nil_chk(self->comparator_)) compareWithId:element1 withId:element2] < 1) {
    JreStrongAssign(&self->minimum_, element1);
    JreStrongAssign(&self->maximum_, element2);
  }
  else {
    JreStrongAssign(&self->minimum_, element2);
    JreStrongAssign(&self->maximum_, element1);
  }
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3Range_ComparableComparator class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (OrgApacheCommonsLang3Range_ComparableComparator_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      OrgApacheCommonsLang3Range_ComparableComparator_initWithNSString_withInt_(e, names[i], i);
    }
