...
FOUNDATION_EXPORT id OrgApacheCommonsLang3ReflectMethodUtils_invokeMethodWithId_withBoolean_withNSString_(id object, jboolean forceAccess, NSString *methodName);
...
FOUNDATION_EXPORT id OrgApacheCommonsLang3ReflectMethodUtils_invokeMethodWithId_withBoolean_withNSString_withNSObjectArray_(id object, jboolean forceAccess, NSString *methodName, IOSObjectArray *args);

FOUNDATION_EXPORT id OrgApacheCommonsLang3ReflectMethodUtils_invokeMethodWithId_withBoolean_withNSString_withNSObjectArray_withIOSClassArray_(id object, jboolean forceAccess, NSString *methodName, IOSObjectArray *args, IOSObjectArray *parameterTypes);
...
FOUNDATION_EXPORT IOSObjectArray *OrgApacheCommonsLang3ReflectMethodUtils_getVarArgsWithNSObjectArray_withIOSClassArray_(IOSObjectArray *args, IOSObjectArray *methodParameterTypes);
...
FOUNDATION_EXPORT JavaLangReflectMethod *OrgApacheCommonsLang3ReflectMethodUtils_getMatchingMethodWithIOSClass_withNSString_withIOSClassArray_(IOSClass *cls, NSString *methodName, IOSObjectArray *parameterTypes);
