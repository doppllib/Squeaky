...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/Conversion.java
//

#include "IOSPrimitiveArray.h"
#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3Conversion.h"
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3Conversion class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_TTTT, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ true, true, true, true } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_FTTT, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ false, true, true, true } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_TFTT, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ true, false, true, true } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_FFTT, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ false, false, true, true } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_TTFT, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ true, true, false, true } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_FTFT, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ false, true, false, true } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_TFFT, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ true, false, false, true } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_FFFT, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ false, false, false, true } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_TTTF, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ true, true, true, false } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_FTTF, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ false, true, true, false } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_TFTF, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ true, false, true, false } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_FFTF, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ false, false, true, false } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_TTFF, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ true, true, false, false } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_FTFF, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ false, true, false, false } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_TFFF, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ true, false, false, false } count:4]);
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3Conversion_FFFF, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ false, false, false, false } count:4]);
...
jint OrgApacheCommonsLang3Conversion_hexDigitToIntWithChar_(jchar hexDigit) {
  ...
  if (digit < 0) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$C$", @"Cannot interpret '", hexDigit, @"' as a hexadecimal digit"));
  }
  return digit;
}
...
jchar OrgApacheCommonsLang3Conversion_binaryToHexDigitWithBooleanArray_withInt_(IOSBooleanArray *src, jint srcPos) {
  ...
  if (((IOSBooleanArray *) nil_chk(src))->size_ == 0) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Cannot convert an empty array.");
  }
...
jchar OrgApacheCommonsLang3Conversion_binaryToHexDigitMsb0_4bitsWithBooleanArray_withInt_(IOSBooleanArray *src, jint srcPos) {
  ...
  if (((IOSBooleanArray *) nil_chk(src))->size_ > 8) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"src.length>8: src.length=", src->size_));
  }
  if (src->size_ - srcPos < 4) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$I", @"src.length-srcPos<4: src.length=", src->size_, @", srcPos=", srcPos));
  }
...
jchar OrgApacheCommonsLang3Conversion_binaryBeMsb0ToHexDigitWithBooleanArray_withInt_(IOSBooleanArray *src, jint srcPos) {
  ...
  IOSBooleanArray *paddedSrc = [IOSBooleanArray arrayWithLength:4];
...
jchar OrgApacheCommonsLang3Conversion_intToHexDigitWithInt_(jint nibble) {
  ...
  if (c == JavaLangCharacter_MIN_VALUE) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"nibble value not between 0 and 15: ", nibble));
  }
  return c;
}
...
jlong OrgApacheCommonsLang3Conversion_intArrayToLongWithIntArray_withInt_withLong_withInt_withInt_(IOSIntArray *src, jint srcPos, jlong dstInit, jint dstPos, jint nInts) {
  ...
  if ((nInts - 1) * 32 + dstPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nInts-1)*32+dstPos is greather or equal to than 64");
  }
  jlong out = dstInit;
  for (jint i = 0; i < nInts; i++) {
    jint shift = i * 32 + dstPos;
...
jlong OrgApacheCommonsLang3Conversion_shortArrayToLongWithShortArray_withInt_withLong_withInt_withInt_(IOSShortArray *src, jint srcPos, jlong dstInit, jint dstPos, jint nShorts) {
  ...
  if ((nShorts - 1) * 16 + dstPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nShorts-1)*16+dstPos is greather or equal to than 64");
  }
  jlong out = dstInit;
  for (jint i = 0; i < nShorts; i++) {
    jint shift = i * 16 + dstPos;
...
jint OrgApacheCommonsLang3Conversion_shortArrayToIntWithShortArray_withInt_withInt_withInt_withInt_(IOSShortArray *src, jint srcPos, jint dstInit, jint dstPos, jint nShorts) {
  ...
  if ((nShorts - 1) * 16 + dstPos >= 32) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nShorts-1)*16+dstPos is greather or equal to than 32");
  }
  jint out = dstInit;
  for (jint i = 0; i < nShorts; i++) {
    jint shift = i * 16 + dstPos;
...
jlong OrgApacheCommonsLang3Conversion_byteArrayToLongWithByteArray_withInt_withLong_withInt_withInt_(IOSByteArray *src, jint srcPos, jlong dstInit, jint dstPos, jint nBytes) {
  ...
  if ((nBytes - 1) * 8 + dstPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nBytes-1)*8+dstPos is greather or equal to than 64");
  }
  jlong out = dstInit;
  for (jint i = 0; i < nBytes; i++) {
    jint shift = i * 8 + dstPos;
...
jint OrgApacheCommonsLang3Conversion_byteArrayToIntWithByteArray_withInt_withInt_withInt_withInt_(IOSByteArray *src, jint srcPos, jint dstInit, jint dstPos, jint nBytes) {
  ...
  if ((nBytes - 1) * 8 + dstPos >= 32) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nBytes-1)*8+dstPos is greather or equal to than 32");
  }
  jint out = dstInit;
  for (jint i = 0; i < nBytes; i++) {
    jint shift = i * 8 + dstPos;
...
jshort OrgApacheCommonsLang3Conversion_byteArrayToShortWithByteArray_withInt_withShort_withInt_withInt_(IOSByteArray *src, jint srcPos, jshort dstInit, jint dstPos, jint nBytes) {
  ...
  if ((nBytes - 1) * 8 + dstPos >= 16) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nBytes-1)*8+dstPos is greather or equal to than 16");
  }
  jshort out = dstInit;
  for (jint i = 0; i < nBytes; i++) {
    jint shift = i * 8 + dstPos;
...
jlong OrgApacheCommonsLang3Conversion_hexToLongWithNSString_withInt_withLong_withInt_withInt_(NSString *src, jint srcPos, jlong dstInit, jint dstPos, jint nHex) {
  ...
  if ((nHex - 1) * 4 + dstPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nHexs-1)*4+dstPos is greather or equal to than 64");
  }
  jlong out = dstInit;
  for (jint i = 0; i < nHex; i++) {
    jint shift = i * 4 + dstPos;
...
jint OrgApacheCommonsLang3Conversion_hexToIntWithNSString_withInt_withInt_withInt_withInt_(NSString *src, jint srcPos, jint dstInit, jint dstPos, jint nHex) {
  ...
  if ((nHex - 1) * 4 + dstPos >= 32) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nHexs-1)*4+dstPos is greather or equal to than 32");
  }
  jint out = dstInit;
  for (jint i = 0; i < nHex; i++) {
    jint shift = i * 4 + dstPos;
...
jshort OrgApacheCommonsLang3Conversion_hexToShortWithNSString_withInt_withShort_withInt_withInt_(NSString *src, jint srcPos, jshort dstInit, jint dstPos, jint nHex) {
  ...
  if ((nHex - 1) * 4 + dstPos >= 16) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nHexs-1)*4+dstPos is greather or equal to than 16");
  }
  jshort out = dstInit;
  for (jint i = 0; i < nHex; i++) {
    jint shift = i * 4 + dstPos;
...
jbyte OrgApacheCommonsLang3Conversion_hexToByteWithNSString_withInt_withByte_withInt_withInt_(NSString *src, jint srcPos, jbyte dstInit, jint dstPos, jint nHex) {
  ...
  if ((nHex - 1) * 4 + dstPos >= 8) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nHexs-1)*4+dstPos is greather or equal to than 8");
  }
  jbyte out = dstInit;
  for (jint i = 0; i < nHex; i++) {
    jint shift = i * 4 + dstPos;
...
jlong OrgApacheCommonsLang3Conversion_binaryToLongWithBooleanArray_withInt_withLong_withInt_withInt_(IOSBooleanArray *src, jint srcPos, jlong dstInit, jint dstPos, jint nBools) {
  ...
  if (nBools - 1 + dstPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBools-1+dstPos is greather or equal to than 64");
  }
  jlong out = dstInit;
...
jint OrgApacheCommonsLang3Conversion_binaryToIntWithBooleanArray_withInt_withInt_withInt_withInt_(IOSBooleanArray *src, jint srcPos, jint dstInit, jint dstPos, jint nBools) {
  ...
  if (nBools - 1 + dstPos >= 32) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBools-1+dstPos is greather or equal to than 32");
  }
  jint out = dstInit;
  for (jint i = 0; i < nBools; i++) {
    jint shift = i + dstPos;
...
jshort OrgApacheCommonsLang3Conversion_binaryToShortWithBooleanArray_withInt_withShort_withInt_withInt_(IOSBooleanArray *src, jint srcPos, jshort dstInit, jint dstPos, jint nBools) {
  ...
  if (nBools - 1 + dstPos >= 16) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBools-1+dstPos is greather or equal to than 16");
  }
  jshort out = dstInit;
  for (jint i = 0; i < nBools; i++) {
    jint shift = i + dstPos;
...
jbyte OrgApacheCommonsLang3Conversion_binaryToByteWithBooleanArray_withInt_withByte_withInt_withInt_(IOSBooleanArray *src, jint srcPos, jbyte dstInit, jint dstPos, jint nBools) {
  ...
  if (nBools - 1 + dstPos >= 8) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBools-1+dstPos is greather or equal to than 8");
  }
  jbyte out = dstInit;
  for (jint i = 0; i < nBools; i++) {
    jint shift = i + dstPos;
...
IOSIntArray *OrgApacheCommonsLang3Conversion_longToIntArrayWithLong_withInt_withIntArray_withInt_withInt_(jlong src, jint srcPos, IOSIntArray *dst, jint dstPos, jint nInts) {
  ...
  if ((nInts - 1) * 32 + srcPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nInts-1)*32+srcPos is greather or equal to than 64");
  }
  for (jint i = 0; i < nInts; i++) {
    jint shift = i * 32 + srcPos;
...
IOSShortArray *OrgApacheCommonsLang3Conversion_longToShortArrayWithLong_withInt_withShortArray_withInt_withInt_(jlong src, jint srcPos, IOSShortArray *dst, jint dstPos, jint nShorts) {
  ...
  if ((nShorts - 1) * 16 + srcPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nShorts-1)*16+srcPos is greather or equal to than 64");
  }
  for (jint i = 0; i < nShorts; i++) {
    jint shift = i * 16 + srcPos;
...
IOSShortArray *OrgApacheCommonsLang3Conversion_intToShortArrayWithInt_withInt_withShortArray_withInt_withInt_(jint src, jint srcPos, IOSShortArray *dst, jint dstPos, jint nShorts) {
  ...
  if ((nShorts - 1) * 16 + srcPos >= 32) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nShorts-1)*16+srcPos is greather or equal to than 32");
  }
  for (jint i = 0; i < nShorts; i++) {
    jint shift = i * 16 + srcPos;
...
IOSByteArray *OrgApacheCommonsLang3Conversion_longToByteArrayWithLong_withInt_withByteArray_withInt_withInt_(jlong src, jint srcPos, IOSByteArray *dst, jint dstPos, jint nBytes) {
  ...
  if ((nBytes - 1) * 8 + srcPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nBytes-1)*8+srcPos is greather or equal to than 64");
  }
  for (jint i = 0; i < nBytes; i++) {
    jint shift = i * 8 + srcPos;
...
IOSByteArray *OrgApacheCommonsLang3Conversion_intToByteArrayWithInt_withInt_withByteArray_withInt_withInt_(jint src, jint srcPos, IOSByteArray *dst, jint dstPos, jint nBytes) {
  ...
  if ((nBytes - 1) * 8 + srcPos >= 32) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nBytes-1)*8+srcPos is greather or equal to than 32");
  }
  for (jint i = 0; i < nBytes; i++) {
    jint shift = i * 8 + srcPos;
...
IOSByteArray *OrgApacheCommonsLang3Conversion_shortToByteArrayWithShort_withInt_withByteArray_withInt_withInt_(jshort src, jint srcPos, IOSByteArray *dst, jint dstPos, jint nBytes) {
  ...
  if ((nBytes - 1) * 8 + srcPos >= 16) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nBytes-1)*8+srcPos is greather or equal to than 16");
  }
  for (jint i = 0; i < nBytes; i++) {
    jint shift = i * 8 + srcPos;
    *IOSByteArray_GetRef(nil_chk(dst), dstPos + i) = (jbyte) ((jint) 0xff & (JreRShift32(src, shift)));
...
NSString *OrgApacheCommonsLang3Conversion_longToHexWithLong_withInt_withNSString_withInt_withInt_(jlong src, jint srcPos, NSString *dstInit, jint dstPos, jint nHexs) {
  ...
  if ((nHexs - 1) * 4 + srcPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nHexs-1)*4+srcPos is greather or equal to than 64");
  }
  JavaLangStringBuilder *sb = create_JavaLangStringBuilder_initWithNSString_(dstInit);
  jint append = [sb length];
  for (jint i = 0; i < nHexs; i++) {
    jint shift = i * 4 + srcPos;
    jint bits = (jint) ((jint) 0xF & (JreRShift64(src, shift)));
    if (dstPos + i == append) {
      ++append;
      [sb appendWithChar:OrgApacheCommonsLang3Conversion_intToHexDigitWithInt_(bits)];
    }
    else {
...
NSString *OrgApacheCommonsLang3Conversion_intToHexWithInt_withInt_withNSString_withInt_withInt_(jint src, jint srcPos, NSString *dstInit, jint dstPos, jint nHexs) {
  ...
  if ((nHexs - 1) * 4 + srcPos >= 32) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nHexs-1)*4+srcPos is greather or equal to than 32");
  }
  JavaLangStringBuilder *sb = create_JavaLangStringBuilder_initWithNSString_(dstInit);
  jint append = [sb length];
  for (jint i = 0; i < nHexs; i++) {
...
NSString *OrgApacheCommonsLang3Conversion_shortToHexWithShort_withInt_withNSString_withInt_withInt_(jshort src, jint srcPos, NSString *dstInit, jint dstPos, jint nHexs) {
  ...
  if ((nHexs - 1) * 4 + srcPos >= 16) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nHexs-1)*4+srcPos is greather or equal to than 16");
  }
  JavaLangStringBuilder *sb = create_JavaLangStringBuilder_initWithNSString_(dstInit);
  jint append = [sb length];
  for (jint i = 0; i < nHexs; i++) {
...
NSString *OrgApacheCommonsLang3Conversion_byteToHexWithByte_withInt_withNSString_withInt_withInt_(jbyte src, jint srcPos, NSString *dstInit, jint dstPos, jint nHexs) {
  ...
  if ((nHexs - 1) * 4 + srcPos >= 8) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"(nHexs-1)*4+srcPos is greather or equal to than 8");
  }
  JavaLangStringBuilder *sb = create_JavaLangStringBuilder_initWithNSString_(dstInit);
  jint append = [sb length];
  for (jint i = 0; i < nHexs; i++) {
...
IOSBooleanArray *OrgApacheCommonsLang3Conversion_longToBinaryWithLong_withInt_withBooleanArray_withInt_withInt_(jlong src, jint srcPos, IOSBooleanArray *dst, jint dstPos, jint nBools) {
  ...
  if (nBools - 1 + srcPos >= 64) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBools-1+srcPos is greather or equal to than 64");
  }
  for (jint i = 0; i < nBools; i++) {
    jint shift = i + srcPos;
...
IOSBooleanArray *OrgApacheCommonsLang3Conversion_intToBinaryWithInt_withInt_withBooleanArray_withInt_withInt_(jint src, jint srcPos, IOSBooleanArray *dst, jint dstPos, jint nBools) {
  ...
  if (nBools - 1 + srcPos >= 32) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBools-1+srcPos is greather or equal to than 32");
  }
  for (jint i = 0; i < nBools; i++) {
    jint shift = i + srcPos;
...
IOSBooleanArray *OrgApacheCommonsLang3Conversion_shortToBinaryWithShort_withInt_withBooleanArray_withInt_withInt_(jshort src, jint srcPos, IOSBooleanArray *dst, jint dstPos, jint nBools) {
  ...
  if (nBools - 1 + srcPos >= 16) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBools-1+srcPos is greather or equal to than 16");
  }
  JreAssert(((nBools - 1) < 16 - srcPos), (@"org/apache/commons/lang3/Conversion.java:1476 condition failed: assert (nBools - 1) < 16 - srcPos;"));
  for (jint i = 0; i < nBools; i++) {
    jint shift = i + srcPos;
    *IOSBooleanArray_GetRef(nil_chk(dst), dstPos + i) = (((jint) 0x1 & (JreRShift32(src, shift))) != 0);
  }
...
IOSBooleanArray *OrgApacheCommonsLang3Conversion_byteToBinaryWithByte_withInt_withBooleanArray_withInt_withInt_(jbyte src, jint srcPos, IOSBooleanArray *dst, jint dstPos, jint nBools) {
  ...
  if (nBools - 1 + srcPos >= 8) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBools-1+srcPos is greather or equal to than 8");
  }
  for (jint i = 0; i < nBools; i++) {
    jint shift = i + srcPos;
    *IOSBooleanArray_GetRef(nil_chk(dst), dstPos + i) = (((jint) 0x1 & (JreRShift32(src, shift))) != 0);
...
IOSByteArray *OrgApacheCommonsLang3Conversion_uuidToByteArrayWithJavaUtilUUID_withByteArray_withInt_withInt_(JavaUtilUUID *src, IOSByteArray *dst, jint dstPos, jint nBytes) {
  ...
  if (nBytes > 16) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"nBytes is greather than 16");
  }
  OrgApacheCommonsLang3Conversion_longToByteArrayWithLong_withInt_withByteArray_withInt_withInt_([((JavaUtilUUID *) nil_chk(src)) getMostSignificantBits], 0, dst, dstPos, nBytes > 8 ? 8 : nBytes);
  if (nBytes >= 8) {
    OrgApacheCommonsLang3Conversion_longToByteArrayWithLong_withInt_withByteArray_withInt_withInt_([src getLeastSignificantBits], 0, dst, dstPos + 8, nBytes - 8);
  }
  return dst;
}
...
JavaUtilUUID *OrgApacheCommonsLang3Conversion_byteArrayToUuidWithByteArray_withInt_(IOSByteArray *src, jint srcPos) {
  ...
  if (((IOSByteArray *) nil_chk(src))->size_ - srcPos < 16) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Need at least 16 bytes for UUID");
  }
  return create_JavaUtilUUID_initWithLong_withLong_(OrgApacheCommonsLang3Conversion_byteArrayToLongWithByteArray_withInt_withLong_withInt_withInt_(src, srcPos, 0, 0, 8), OrgApacheCommonsLang3Conversion_byteArrayToLongWithByteArray_withInt_withLong_withInt_withInt_(src, srcPos + 8, 0, 0, 8));
}
