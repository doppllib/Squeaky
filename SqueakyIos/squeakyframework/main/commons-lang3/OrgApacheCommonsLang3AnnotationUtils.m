...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/AnnotationUtils.java
//
...
#include "OrgApacheCommonsLang3AnnotationUtils.h"
...
inline OrgApacheCommonsLang3BuilderToStringStyle *OrgApacheCommonsLang3AnnotationUtils_get_TO_STRING_STYLE();
...
inline jlong OrgApacheCommonsLang3AnnotationUtils_1_get_serialVersionUID();
...
__attribute__((unused)) static OrgApacheCommonsLang3AnnotationUtils_1 *new_OrgApacheCommonsLang3AnnotationUtils_1_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgApacheCommonsLang3AnnotationUtils_1 *create_OrgApacheCommonsLang3AnnotationUtils_1_init();
...
- (NSString *)getShortClassNameWithIOSClass:(IOSClass *)cls {
  ...
  return [((JavaLangStringBuilder *) nil_chk([create_JavaLangStringBuilder_initWithNSString_(annotationType == nil ? OrgApacheCommonsLang3StringUtils_EMPTY : [annotationType getName]) insertWithInt:0 withChar:'@'])) description];
}
