...
FOUNDATION_EXPORT jboolean OrgApacheCommonsLang3ObjectUtils_anyNotNullWithNSObjectArray_(IOSObjectArray *values);

FOUNDATION_EXPORT jboolean OrgApacheCommonsLang3ObjectUtils_allNotNullWithNSObjectArray_(IOSObjectArray *values);
