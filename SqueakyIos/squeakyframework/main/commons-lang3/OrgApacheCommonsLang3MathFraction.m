...
#include "OrgApacheCommonsLang3MathFraction.h"
...
inline jlong OrgApacheCommonsLang3MathFraction_get_serialVersionUID();
...
- (NSString *)description {
  if (toString_ == nil) {
    JreStrongAssign(&toString_, JreStrcat("ICI", [self getNumerator], '/', [self getDenominator]));
  }
  return toString_;
}
  ...
  if (toProperString_ == nil) {
    if (numerator_ == 0) {
      ...
      if (properNumerator == 0) {
        ...
        JreStrongAssign(&toProperString_, JreStrcat("ICICI", [self getProperWhole], ' ', properNumerator, '/', [self getDenominator]));
      }
    }
    else {
      JreStrongAssign(&toProperString_, JreStrcat("ICI", [self getNumerator], '/', [self getDenominator]));
    }
  }
