...
FOUNDATION_EXPORT void OrgApacheCommonsLang3Validate_notNaNWithDouble_(jdouble value);

FOUNDATION_EXPORT void OrgApacheCommonsLang3Validate_notNaNWithDouble_withNSString_withNSObjectArray_(jdouble value, NSString *message, IOSObjectArray *values);

FOUNDATION_EXPORT void OrgApacheCommonsLang3Validate_finiteWithDouble_(jdouble value);

FOUNDATION_EXPORT void OrgApacheCommonsLang3Validate_finiteWithDouble_withNSString_withNSObjectArray_(jdouble value, NSString *message, IOSObjectArray *values);
