...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/event/EventListenerSupport.java
//

#include "IOSClass.h"
#include "IOSObjectArray.h"
#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3EventEventListenerSupport.h"
...
- (void)addListenerWithId:(id)listener {
  [self addListenerWithId:listener withBoolean:true];
}

- (void)addListenerWithId:(id)listener
              withBoolean:(jboolean)allowDuplicate {
  OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(listener, @"Listener object cannot be null.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  if (allowDuplicate) {
    [((id<JavaUtilList>) nil_chk(listeners_)) addWithId:listener];
  }
  else if (![((id<JavaUtilList>) nil_chk(listeners_)) containsWithId:listener]) {
    [((id<JavaUtilList>) nil_chk(listeners_)) addWithId:listener];
  }
}
...
- (void)writeObjectWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)objectOutputStream {
  JavaUtilArrayList *serializableListeners = create_JavaUtilArrayList_init();
  JavaIoObjectOutputStream *testObjectOutputStream = create_JavaIoObjectOutputStream_initWithJavaIoOutputStream_(create_JavaIoByteArrayOutputStream_init());
  for (id __strong listener in nil_chk(listeners_)) {
    ...
    @catch (JavaIoIOException *exception) {
      testObjectOutputStream = create_JavaIoObjectOutputStream_initWithJavaIoOutputStream_(create_JavaIoByteArrayOutputStream_init());
    }
  }
...
- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)objectInputStream {
  ...
  JreStrongAssignAndConsume(&self->listeners_, new_JavaUtilConcurrentCopyOnWriteArrayList_initWithNSObjectArray_(srcListeners));
...
- (id<JavaLangReflectInvocationHandler>)createInvocationHandler {
  return create_OrgApacheCommonsLang3EventEventListenerSupport_ProxyInvocationHandler_initWithOrgApacheCommonsLang3EventEventListenerSupport_(self);
}

- (void)dealloc {
  RELEASE_(listeners_);
  RELEASE_(proxy_);
  RELEASE_(prototypeArray_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(addListenerWithId:withBoolean:);
  methods[7].selector = @selector(getListenerCount);
  methods[8].selector = @selector(removeListenerWithId:);
  methods[9].selector = @selector(getListeners);
  methods[10].selector = @selector(writeObjectWithJavaIoObjectOutputStream:);
  methods[11].selector = @selector(readObjectWithJavaIoObjectInputStream:);
  methods[12].selector = @selector(initializeTransientFieldsWithIOSClass:withJavaLangClassLoader:);
  methods[13].selector = @selector(createProxyWithIOSClass:withJavaLangClassLoader:);
  methods[14].selector = @selector(createInvocationHandler);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "listeners_", "LJavaUtilList;", .constantValue.asLong = 0, 0x2, -1, -1, 22, -1 },
    { "proxy_", "LNSObject;", .constantValue.asLong = 0, 0x82, -1, -1, 23, -1 },
    { "prototypeArray_", "[LNSObject;", .constantValue.asLong = 0, 0x82, -1, -1, 24, -1 },
  };
  static const void *ptrTable[] = { "create", "LIOSClass;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)Lorg/apache/commons/lang3/event/EventListenerSupport<TT;>;", "(Ljava/lang/Class<TL;>;)V", "LIOSClass;LJavaLangClassLoader;", "(Ljava/lang/Class<TL;>;Ljava/lang/ClassLoader;)V", "()TL;", "addListener", "LNSObject;", "(TL;)V", "LNSObject;Z", "(TL;Z)V", "removeListener", "()[TL;", "writeObject", "LJavaIoObjectOutputStream;", "LJavaIoIOException;", "readObject", "LJavaIoObjectInputStream;", "LJavaIoIOException;LJavaLangClassNotFoundException;", "initializeTransientFields", "createProxy", "Ljava/util/List<TL;>;", "TL;", "[TL;", "LOrgApacheCommonsLang3EventEventListenerSupport_ProxyInvocationHandler;", "<L:Ljava/lang/Object;>Ljava/lang/Object;Ljava/io/Serializable;" };
  static const J2ObjcClassInfo _OrgApacheCommonsLang3EventEventListenerSupport = { "EventListenerSupport", "org.apache.commons.lang3.event", ptrTable, methods, fields, 7, 0x1, 15, 4, -1, 25, -1, 26, -1 };
...
OrgApacheCommonsLang3EventEventListenerSupport *OrgApacheCommonsLang3EventEventListenerSupport_createWithIOSClass_(IOSClass *listenerInterface) {
  ...
  return create_OrgApacheCommonsLang3EventEventListenerSupport_initWithIOSClass_(listenerInterface);
}
...
void OrgApacheCommonsLang3EventEventListenerSupport_initWithIOSClass_withJavaLangClassLoader_(OrgApacheCommonsLang3EventEventListenerSupport *self, IOSClass *listenerInterface, JavaLangClassLoader *classLoader) {
  OrgApacheCommonsLang3EventEventListenerSupport_init(self);
  OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(listenerInterface, @"Listener interface cannot be null.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  OrgApacheCommonsLang3Validate_notNullWithId_withNSString_withNSObjectArray_(classLoader, @"ClassLoader cannot be null.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_([((IOSClass *) nil_chk(listenerInterface)) isInterface], @"Class {0} is not an interface", [IOSObjectArray arrayWithObjects:(id[]){ [listenerInterface getName] } count:1 type:NSObject_class_()]);
  OrgApacheCommonsLang3EventEventListenerSupport_initializeTransientFieldsWithIOSClass_withJavaLangClassLoader_(self, listenerInterface, classLoader);
}
...
void OrgApacheCommonsLang3EventEventListenerSupport_initializeTransientFieldsWithIOSClass_withJavaLangClassLoader_(OrgApacheCommonsLang3EventEventListenerSupport *self, IOSClass *listenerInterface, JavaLangClassLoader *classLoader) {
  ...
  JreStrongAssign(&self->prototypeArray_, array);
  OrgApacheCommonsLang3EventEventListenerSupport_createProxyWithIOSClass_withJavaLangClassLoader_(self, listenerInterface, classLoader);
}
...
void OrgApacheCommonsLang3EventEventListenerSupport_createProxyWithIOSClass_withJavaLangClassLoader_(OrgApacheCommonsLang3EventEventListenerSupport *self, IOSClass *listenerInterface, JavaLangClassLoader *classLoader) {
  JreStrongAssign(&self->proxy_, [((IOSClass *) nil_chk(listenerInterface)) cast:JavaLangReflectProxy_newProxyInstanceWithJavaLangClassLoader_withIOSClassArray_withJavaLangReflectInvocationHandler_(classLoader, [IOSObjectArray arrayWithObjects:(id[]){ listenerInterface } count:1 type:IOSClass_class_()], [self createInvocationHandler])]);
}
...
withJavaLangReflectMethod:(JavaLangReflectMethod *)method
 withNSObjectArray:(IOSObjectArray *)args {
  for (id __strong listener in nil_chk(this$0_->listeners_)) {
    [((JavaLangReflectMethod *) nil_chk(method)) invokeWithId:listener withNSObjectArray:args];
  }
  return nil;
}
