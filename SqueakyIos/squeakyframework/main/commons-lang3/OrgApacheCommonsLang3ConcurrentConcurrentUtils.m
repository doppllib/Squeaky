...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/concurrent/ConcurrentUtils.java
//

#include "IOSClass.h"
#include "IOSObjectArray.h"
#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3ConcurrentConcurrentException.h"
#include "OrgApacheCommonsLang3ConcurrentConcurrentInitializer.h"
#include "OrgApacheCommonsLang3ConcurrentConcurrentRuntimeException.h"
#include "OrgApacheCommonsLang3ConcurrentConcurrentUtils.h"
...
__attribute__((unused)) static OrgApacheCommonsLang3ConcurrentConcurrentUtils *new_OrgApacheCommonsLang3ConcurrentConcurrentUtils_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgApacheCommonsLang3ConcurrentConcurrentUtils *create_OrgApacheCommonsLang3ConcurrentConcurrentUtils_init();
...
+ (NSException *)checkedExceptionWithNSException:(NSException *)ex {
  return OrgApacheCommonsLang3ConcurrentConcurrentUtils_checkedExceptionWithNSException_(ex);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSException;", 0x8, 6, 7, -1, -1, -1, -1 },
  ...
  methods[5].selector = @selector(checkedExceptionWithNSException:);
...
OrgApacheCommonsLang3ConcurrentConcurrentException *OrgApacheCommonsLang3ConcurrentConcurrentUtils_extractCauseWithJavaUtilConcurrentExecutionException_(JavaUtilConcurrentExecutionException *ex) {
  ...
  OrgApacheCommonsLang3ConcurrentConcurrentUtils_throwCauseWithJavaUtilConcurrentExecutionException_(ex);
  return create_OrgApacheCommonsLang3ConcurrentConcurrentException_initWithNSString_withNSException_([ex getMessage], [ex getCause]);
}
...
OrgApacheCommonsLang3ConcurrentConcurrentRuntimeException *OrgApacheCommonsLang3ConcurrentConcurrentUtils_extractCauseUncheckedWithJavaUtilConcurrentExecutionException_(JavaUtilConcurrentExecutionException *ex) {
  ...
  OrgApacheCommonsLang3ConcurrentConcurrentUtils_throwCauseWithJavaUtilConcurrentExecutionException_(ex);
  return create_OrgApacheCommonsLang3ConcurrentConcurrentRuntimeException_initWithNSString_withNSException_([ex getMessage], [ex getCause]);
}
...
NSException *OrgApacheCommonsLang3ConcurrentConcurrentUtils_checkedExceptionWithNSException_(NSException *ex) {
  OrgApacheCommonsLang3ConcurrentConcurrentUtils_initialize();
...
void OrgApacheCommonsLang3ConcurrentConcurrentUtils_throwCauseWithJavaUtilConcurrentExecutionException_(JavaUtilConcurrentExecutionException *ex) {
  ...
  if ([[ex getCause] isKindOfClass:[JavaLangError class]]) {
    @throw (JavaLangError *) cast_chk([ex getCause], [JavaLangError class]);
  }
}
...
id OrgApacheCommonsLang3ConcurrentConcurrentUtils_initializeUncheckedWithOrgApacheCommonsLang3ConcurrentConcurrentInitializer_(id<OrgApacheCommonsLang3ConcurrentConcurrentInitializer> initializer) {
  ...
  @catch (OrgApacheCommonsLang3ConcurrentConcurrentException *cex) {
    @throw create_OrgApacheCommonsLang3ConcurrentConcurrentRuntimeException_initWithNSException_([((OrgApacheCommonsLang3ConcurrentConcurrentException *) nil_chk(cex)) getCause]);
  }
}
