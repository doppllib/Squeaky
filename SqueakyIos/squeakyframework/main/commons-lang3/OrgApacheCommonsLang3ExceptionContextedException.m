...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/exception/ContextedException.java
//

#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3ExceptionContextedException.h"
...
inline jlong OrgApacheCommonsLang3ExceptionContextedException_get_serialVersionUID();
...
- (instancetype)initWithNSException:(NSException *)cause {
  OrgApacheCommonsLang3ExceptionContextedException_initWithNSException_(self, cause);
  return self;
}

- (instancetype)initWithNSString:(NSString *)message
                 withNSException:(NSException *)cause {
  OrgApacheCommonsLang3ExceptionContextedException_initWithNSString_withNSException_(self, message, cause);
  return self;
}
...
withOrgApacheCommonsLang3ExceptionExceptionContext:(id<OrgApacheCommonsLang3ExceptionExceptionContext>)context {
  OrgApacheCommonsLang3ExceptionContextedException_initWithNSString_withNSException_withOrgApacheCommonsLang3ExceptionExceptionContext_(self, message, cause, context);
  return self;
}
...
void OrgApacheCommonsLang3ExceptionContextedException_initWithNSException_(OrgApacheCommonsLang3ExceptionContextedException *self, NSException *cause) {
  JavaLangException_initWithNSException_(self, cause);
  JreStrongAssignAndConsume(&self->exceptionContext_, new_OrgApacheCommonsLang3ExceptionDefaultExceptionContext_init());
}

OrgApacheCommonsLang3ExceptionContextedException *new_OrgApacheCommonsLang3ExceptionContextedException_initWithNSException_(NSException *cause) {
  J2OBJC_NEW_IMPL(OrgApacheCommonsLang3ExceptionContextedException, initWithNSException_, cause)
}

OrgApacheCommonsLang3ExceptionContextedException *create_OrgApacheCommonsLang3ExceptionContextedException_initWithNSException_(NSException *cause) {
  J2OBJC_CREATE_IMPL(OrgApacheCommonsLang3ExceptionContextedException, initWithNSException_, cause)
}

void OrgApacheCommonsLang3ExceptionContextedException_initWithNSString_withNSException_(OrgApacheCommonsLang3ExceptionContextedException *self, NSString *message, NSException *cause) {
  JavaLangException_initWithNSString_withNSException_(self, message, cause);
  JreStrongAssignAndConsume(&self->exceptionContext_, new_OrgApacheCommonsLang3ExceptionDefaultExceptionContext_init());
}

OrgApacheCommonsLang3ExceptionContextedException *new_OrgApacheCommonsLang3ExceptionContextedException_initWithNSString_withNSException_(NSString *message, NSException *cause) {
  J2OBJC_NEW_IMPL(OrgApacheCommonsLang3ExceptionContextedException, initWithNSString_withNSException_, message, cause)
}

OrgApacheCommonsLang3ExceptionContextedException *create_OrgApacheCommonsLang3ExceptionContextedException_initWithNSString_withNSException_(NSString *message, NSException *cause) {
  J2OBJC_CREATE_IMPL(OrgApacheCommonsLang3ExceptionContextedException, initWithNSString_withNSException_, message, cause)
}

void OrgApacheCommonsLang3ExceptionContextedException_initWithNSString_withNSException_withOrgApacheCommonsLang3ExceptionExceptionContext_(OrgApacheCommonsLang3ExceptionContextedException *self, NSString *message, NSException *cause, id<OrgApacheCommonsLang3ExceptionExceptionContext> context) {
  JavaLangException_initWithNSString_withNSException_(self, message, cause);
  if (context == nil) {
...
OrgApacheCommonsLang3ExceptionContextedException *new_OrgApacheCommonsLang3ExceptionContextedException_initWithNSString_withNSException_withOrgApacheCommonsLang3ExceptionExceptionContext_(NSString *message, NSException *cause, id<OrgApacheCommonsLang3ExceptionExceptionContext> context) {
  J2OBJC_NEW_IMPL(OrgApacheCommonsLang3ExceptionContextedException, initWithNSString_withNSException_withOrgApacheCommonsLang3ExceptionExceptionContext_, message, cause, context)
}

OrgApacheCommonsLang3ExceptionContextedException *create_OrgApacheCommonsLang3ExceptionContextedException_initWithNSString_withNSException_withOrgApacheCommonsLang3ExceptionExceptionContext_(NSString *message, NSException *cause, id<OrgApacheCommonsLang3ExceptionExceptionContext> context) {
  J2OBJC_CREATE_IMPL(OrgApacheCommonsLang3ExceptionContextedException, initWithNSString_withNSException_withOrgApacheCommonsLang3ExceptionExceptionContext_, message, cause, context)
}
