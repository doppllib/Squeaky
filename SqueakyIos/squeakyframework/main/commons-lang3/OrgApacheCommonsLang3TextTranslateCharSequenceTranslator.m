...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/text/translate/CharSequenceTranslator.java
//
...
- (NSString *)translateWithJavaLangCharSequence:(id<JavaLangCharSequence>)input {
  ...
  @try {
    JavaIoStringWriter *writer = create_JavaIoStringWriter_initWithInt_([input length] * 2);
