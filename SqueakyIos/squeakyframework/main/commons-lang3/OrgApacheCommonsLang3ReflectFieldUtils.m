...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/reflect/FieldUtils.java
//
...
#include "OrgApacheCommonsLang3ReflectFieldUtils.h"
...
JavaLangReflectField *OrgApacheCommonsLang3ReflectFieldUtils_getFieldWithIOSClass_withNSString_withBoolean_(IOSClass *cls, NSString *fieldName, jboolean forceAccess) {
  ...
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(OrgApacheCommonsLang3StringUtils_isNotBlankWithJavaLangCharSequence_(fieldName), @"The field name must not be blank/empty", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  ...
  for (IOSClass * __strong class1 in nil_chk(OrgApacheCommonsLang3ClassUtils_getAllInterfacesWithIOSClass_(cls))) {
    @try {
      ...
      OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(match == nil, @"Reference to field %s is ambiguous relative to %s; a matching field exists on two or more implemented interfaces.", [IOSObjectArray arrayWithObjects:(id[]){ fieldName, cls } count:2 type:NSObject_class_()]);
      match = test;
    }
    @catch (JavaLangNoSuchFieldException *ex) {
    }
...
IOSObjectArray *OrgApacheCommonsLang3ReflectFieldUtils_getAllFieldsWithIOSClass_(IOSClass *cls) {
  ...
  return [((id<JavaUtilList>) nil_chk(allFieldsList)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[allFieldsList size] type:JavaLangReflectField_class_()]];
}
...
IOSObjectArray *OrgApacheCommonsLang3ReflectFieldUtils_getFieldsWithAnnotationWithIOSClass_withIOSClass_(IOSClass *cls, IOSClass *annotationCls) {
  ...
  return [((id<JavaUtilList>) nil_chk(annotatedFieldsList)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[annotatedFieldsList size] type:JavaLangReflectField_class_()]];
}
...
id<JavaUtilList> OrgApacheCommonsLang3ReflectFieldUtils_getFieldsListWithAnnotationWithIOSClass_withIOSClass_(IOSClass *cls, IOSClass *annotationCls) {
  ...
  id<JavaUtilList> annotatedFields = create_JavaUtilArrayList_init();
...
id OrgApacheCommonsLang3ReflectFieldUtils_readStaticFieldWithJavaLangReflectField_withBoolean_(JavaLangReflectField *field, jboolean forceAccess) {
  OrgApacheCommonsLang3ReflectFieldUtils_initialize();
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(field != nil, @"The field must not be null", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(JavaLangReflectModifier_isStaticWithInt_([((JavaLangReflectField *) nil_chk(field)) getModifiers]), @"The field '%s' is not static", [IOSObjectArray arrayWithObjects:(id[]){ [field getName] } count:1 type:NSObject_class_()]);
...
id OrgApacheCommonsLang3ReflectFieldUtils_readStaticFieldWithIOSClass_withNSString_withBoolean_(IOSClass *cls, NSString *fieldName, jboolean forceAccess) {
  ...
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(field != nil, @"Cannot locate field '%s' on %s", [IOSObjectArray arrayWithObjects:(id[]){ fieldName, cls } count:2 type:NSObject_class_()]);
  return OrgApacheCommonsLang3ReflectFieldUtils_readStaticFieldWithJavaLangReflectField_withBoolean_(field, false);
}
...
id OrgApacheCommonsLang3ReflectFieldUtils_readDeclaredStaticFieldWithIOSClass_withNSString_withBoolean_(IOSClass *cls, NSString *fieldName, jboolean forceAccess) {
  ...
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(field != nil, @"Cannot locate declared field %s.%s", [IOSObjectArray arrayWithObjects:(id[]){ [((IOSClass *) nil_chk(cls)) getName], fieldName } count:2 type:NSObject_class_()]);
  return OrgApacheCommonsLang3ReflectFieldUtils_readStaticFieldWithJavaLangReflectField_withBoolean_(field, false);
}
...
id OrgApacheCommonsLang3ReflectFieldUtils_readFieldWithId_withNSString_withBoolean_(id target, NSString *fieldName, jboolean forceAccess) {
  OrgApacheCommonsLang3ReflectFieldUtils_initialize();
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(target != nil, @"target object must not be null", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
...
id OrgApacheCommonsLang3ReflectFieldUtils_readDeclaredFieldWithId_withNSString_withBoolean_(id target, NSString *fieldName, jboolean forceAccess) {
  ...
  IOSClass *cls = [nil_chk(target) java_getClass];
  JavaLangReflectField *field = OrgApacheCommonsLang3ReflectFieldUtils_getDeclaredFieldWithIOSClass_withNSString_withBoolean_(cls, fieldName, forceAccess);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(field != nil, @"Cannot locate declared field %s.%s", [IOSObjectArray arrayWithObjects:(id[]){ cls, fieldName } count:2 type:NSObject_class_()]);
  return OrgApacheCommonsLang3ReflectFieldUtils_readFieldWithJavaLangReflectField_withId_withBoolean_(field, target, false);
}
...
void OrgApacheCommonsLang3ReflectFieldUtils_writeFieldWithId_withNSString_withId_withBoolean_(id target, NSString *fieldName, id value, jboolean forceAccess) {
  ...
  IOSClass *cls = [nil_chk(target) java_getClass];
  JavaLangReflectField *field = OrgApacheCommonsLang3ReflectFieldUtils_getFieldWithIOSClass_withNSString_withBoolean_(cls, fieldName, forceAccess);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(field != nil, @"Cannot locate declared field %s.%s", [IOSObjectArray arrayWithObjects:(id[]){ [cls getName], fieldName } count:2 type:NSObject_class_()]);
  OrgApacheCommonsLang3ReflectFieldUtils_writeFieldWithJavaLangReflectField_withId_withId_withBoolean_(field, target, value, false);
}
