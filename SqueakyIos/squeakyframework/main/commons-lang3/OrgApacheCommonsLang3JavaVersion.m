...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/JavaVersion.java
//
...
__attribute__((unused)) static jfloat OrgApacheCommonsLang3JavaVersion_maxVersion();
...
OrgApacheCommonsLang3JavaVersion *OrgApacheCommonsLang3JavaVersion_values_[12];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "JAVA_9", "LOrgApacheCommonsLang3JavaVersion;", .constantValue.asLong = 0, 0x4019, -1, 18, -1, -1 },
    { "JAVA_RECENT", "LOrgApacheCommonsLang3JavaVersion;", .constantValue.asLong = 0, 0x4019, -1, 19, -1, -1 },
    { "value_", "F", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
    { "name_JavaVersion_", "LNSString;", .constantValue.asLong = 0, 0x12, 20, -1, -1, -1 },
  };
  ...
  static const J2ObjcClassInfo _OrgApacheCommonsLang3JavaVersion = { "JavaVersion", "org.apache.commons.lang3", ptrTable, methods, fields, 7, 0x4011, 8, 14, -1, -1, -1, 21, -1 };
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3JavaVersion class]) {
    ...
    id e;
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_0_9) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.5f, @"0.9", @"JAVA_0_9", 0);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_1) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.1f, @"1.1", @"JAVA_1_1", 1);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_2) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.2f, @"1.2", @"JAVA_1_2", 2);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_3) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.3f, @"1.3", @"JAVA_1_3", 3);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_4) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.4f, @"1.4", @"JAVA_1_4", 4);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_5) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.5f, @"1.5", @"JAVA_1_5", 5);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_6) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.6f, @"1.6", @"JAVA_1_6", 6);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_7) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.7f, @"1.7", @"JAVA_1_7", 7);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_8) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 1.8f, @"1.8", @"JAVA_1_8", 8);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_1_9) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 9.0f, @"9", @"JAVA_1_9", 9);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_9) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, 9.0f, @"9", @"JAVA_9", 10);
    (JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_RECENT) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(e, OrgApacheCommonsLang3JavaVersion_maxVersion(), JavaLangFloat_toStringWithFloat_(OrgApacheCommonsLang3JavaVersion_maxVersion()), @"JAVA_RECENT", 11);
...
void OrgApacheCommonsLang3JavaVersion_initWithFloat_withNSString_withNSString_withInt_(OrgApacheCommonsLang3JavaVersion *self, jfloat value, NSString *name, NSString *__name, jint __ordinal) {
  ...
  self->value_ = value;
  JreStrongAssign(&self->name_JavaVersion_, name);
}
...
OrgApacheCommonsLang3JavaVersion *OrgApacheCommonsLang3JavaVersion_getWithNSString_(NSString *nom) {
  ...
  else if ([@"9" isEqual:nom]) {
    return JreEnum(OrgApacheCommonsLang3JavaVersion, JAVA_9);
  }
  if (nom == nil) {
    return nil;
  }
  ...
  if ((v - 1.) < 1.) {
    ...
    jint end = JavaLangMath_maxWithInt_withInt_(((jint) [nom length]), [nom java_indexOf:',' fromIndex:firstComma]);
...
jfloat OrgApacheCommonsLang3JavaVersion_maxVersion() {
  OrgApacheCommonsLang3JavaVersion_initialize();
  jfloat v = OrgApacheCommonsLang3JavaVersion_toFloatVersionWithNSString_(JavaLangSystem_getPropertyWithNSString_withNSString_(@"java.specification.version", @"99.0"));
  if (v > 0) {
    return v;
  }
  return 99.0f;
...
jfloat OrgApacheCommonsLang3JavaVersion_toFloatVersionWithNSString_(NSString *value) {
  OrgApacheCommonsLang3JavaVersion_initialize();
  jint defaultReturnValue = -1;
  if ([((NSString *) nil_chk(value)) java_contains:@"."]) {
    IOSObjectArray *toParse = [value java_split:@"\\."];
    if (((IOSObjectArray *) nil_chk(toParse))->size_ >= 2) {
      return OrgApacheCommonsLang3MathNumberUtils_toFloatWithNSString_withFloat_(JreStrcat("$C$", IOSObjectArray_Get(toParse, 0), '.', IOSObjectArray_Get(toParse, 1)), defaultReturnValue);
    }
  }
  else {
    return OrgApacheCommonsLang3MathNumberUtils_toFloatWithNSString_withFloat_(value, defaultReturnValue);
  }
...
IOSObjectArray *OrgApacheCommonsLang3JavaVersion_values() {
  OrgApacheCommonsLang3JavaVersion_initialize();
  return [IOSObjectArray arrayWithObjects:OrgApacheCommonsLang3JavaVersion_values_ count:12 type:OrgApacheCommonsLang3JavaVersion_class_()];
}
