...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/SerializationUtils.java
//

#include "IOSClass.h"
#include "IOSPrimitiveArray.h"
#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3SerializationException.h"
#include "OrgApacheCommonsLang3SerializationUtils.h"
...
inline id<JavaUtilMap> OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_get_primitiveTypes();
...
id<JavaIoSerializable> OrgApacheCommonsLang3SerializationUtils_cloneWithJavaIoSerializable_(id<JavaIoSerializable> object) {
  ...
  @catch (JavaLangClassNotFoundException *ex) {
    @throw create_OrgApacheCommonsLang3SerializationException_initWithNSString_withNSException_(@"ClassNotFoundException while reading cloned object data", ex);
  }
  @catch (JavaIoIOException *ex) {
    @throw create_OrgApacheCommonsLang3SerializationException_initWithNSString_withNSException_(@"IOException while reading cloned object data", ex);
  }
  @finally {
    @try {
      if (in != nil) {
    ...
    @catch (JavaIoIOException *ex) {
      @throw create_OrgApacheCommonsLang3SerializationException_initWithNSString_withNSException_(@"IOException on closing cloned object data InputStream.", ex);
    }
  }
}
...
void OrgApacheCommonsLang3SerializationUtils_serializeWithJavaIoSerializable_withJavaIoOutputStream_(id<JavaIoSerializable> obj, JavaIoOutputStream *outputStream) {
  ...
  @catch (JavaIoIOException *ex) {
    @throw create_OrgApacheCommonsLang3SerializationException_initWithNSException_(ex);
  }
  @finally {
    @try {
      if (out != nil) {
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream class]) {
    ...
    {
      [OrgApacheCommonsLang3SerializationUtils_ClassLoaderAwareObjectInputStream_primitiveTypes putWithId:@"byte" withId:[IOSClass byteClass]];
