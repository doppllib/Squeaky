...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/builder/HashCodeBuilder.java
//
...
#include "OrgApacheCommonsLang3BuilderHashCodeExclude.h"
...
- (void)appendArrayWithId:(id)object;

@end

inline jint OrgApacheCommonsLang3BuilderHashCodeBuilder_get_DEFAULT_INITIAL_VALUE();
...
inline jint OrgApacheCommonsLang3BuilderHashCodeBuilder_get_DEFAULT_MULTIPLIER_VALUE();
...
inline JavaLangThreadLocal *OrgApacheCommonsLang3BuilderHashCodeBuilder_get_REGISTRY();
...
__attribute__((unused)) static void OrgApacheCommonsLang3BuilderHashCodeBuilder_register__WithId_(id value);

__attribute__((unused)) static void OrgApacheCommonsLang3BuilderHashCodeBuilder_unregisterWithId_(id value);

__attribute__((unused)) static void OrgApacheCommonsLang3BuilderHashCodeBuilder_appendArrayWithId_(OrgApacheCommonsLang3BuilderHashCodeBuilder *self, id object);
  ...
  if (array == nil) {
  ...
  else {
    {
      ...
      while (b__ < e__) {
        ...
        [self appendWithBoolean:element];
      }
    }
  }
  return self;
...
- (OrgApacheCommonsLang3BuilderHashCodeBuilder *)appendWithId:(id)object {
  if (object == nil) {
    ...
    if ([[object java_getClass] isArray]) {
      OrgApacheCommonsLang3BuilderHashCodeBuilder_appendArrayWithId_(self, object);
    }
    else {
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "V", 0xa, 15, 2, -1, -1, -1, -1 },
    { NULL, "V", 0xa, 16, 2, -1, -1, -1, -1 },
    ...
    { NULL, "LOrgApacheCommonsLang3BuilderHashCodeBuilder;", 0x1, 18, 36, -1, -1, -1, -1 },
    { NULL, "LOrgApacheCommonsLang3BuilderHashCodeBuilder;", 0x1, 37, 29, -1, -1, -1, -1 },
  ...
  methods[28].selector = @selector(appendArrayWithId:);
  methods[29].selector = @selector(appendWithNSObjectArray:);
  methods[30].selector = @selector(appendWithShort:);
  methods[31].selector = @selector(appendWithShortArray:);
  methods[32].selector = @selector(appendSuperWithInt:);
  methods[33].selector = @selector(toHashCode);
  methods[34].selector = @selector(build);
...
jboolean OrgApacheCommonsLang3BuilderHashCodeBuilder_isRegisteredWithId_(id value) {
  ...
  return registry != nil && [registry containsWithId:create_OrgApacheCommonsLang3BuilderIDKey_initWithId_(value)];
}
  ...
  @try {
    ...
    JavaLangReflectAccessibleObject_setAccessibleWithJavaLangReflectAccessibleObjectArray_withBoolean_(fields, true);
    {
      ...
      while (b__ < e__) {
        ...
        if (!OrgApacheCommonsLang3ArrayUtils_containsWithNSObjectArray_withId_(excludeFields, [((JavaLangReflectField *) nil_chk(field)) getName]) && ![((NSString *) nil_chk([field getName])) java_contains:@"$"] && (useTransients || !JavaLangReflectModifier_isTransientWithInt_([field getModifiers])) && !JavaLangReflectModifier_isStaticWithInt_([field getModifiers]) && ![field isAnnotationPresentWithIOSClass:OrgApacheCommonsLang3BuilderHashCodeExclude_class_()]) {
          @try {
            id fieldValue = [field getWithId:object];
            [((OrgApacheCommonsLang3BuilderHashCodeBuilder *) nil_chk(builder)) appendWithId:fieldValue];
          }
...
jint OrgApacheCommonsLang3BuilderHashCodeBuilder_reflectionHashCodeWithInt_withInt_withId_(jint initialNonZeroOddNumber, jint multiplierNonZeroOddNumber, id object) {
  OrgApacheCommonsLang3BuilderHashCodeBuilder_initialize();
  return OrgApacheCommonsLang3BuilderHashCodeBuilder_reflectionHashCodeWithInt_withInt_withId_withBoolean_withIOSClass_withNSStringArray_(initialNonZeroOddNumber, multiplierNonZeroOddNumber, object, false, nil, [IOSObjectArray arrayWithLength:0 type:NSString_class_()]);
}
...
jint OrgApacheCommonsLang3BuilderHashCodeBuilder_reflectionHashCodeWithInt_withInt_withId_withBoolean_(jint initialNonZeroOddNumber, jint multiplierNonZeroOddNumber, id object, jboolean testTransients) {
  OrgApacheCommonsLang3BuilderHashCodeBuilder_initialize();
  return OrgApacheCommonsLang3BuilderHashCodeBuilder_reflectionHashCodeWithInt_withInt_withId_withBoolean_withIOSClass_withNSStringArray_(initialNonZeroOddNumber, multiplierNonZeroOddNumber, object, testTransients, nil, [IOSObjectArray arrayWithLength:0 type:NSString_class_()]);
}
...
jint OrgApacheCommonsLang3BuilderHashCodeBuilder_reflectionHashCodeWithInt_withInt_withId_withBoolean_withIOSClass_withNSStringArray_(jint initialNonZeroOddNumber, jint multiplierNonZeroOddNumber, id object, jboolean testTransients, IOSClass *reflectUpToClass, IOSObjectArray *excludeFields) {
  OrgApacheCommonsLang3BuilderHashCodeBuilder_initialize();
  if (object == nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"The object to build a hash code for must not be null");
  }
  OrgApacheCommonsLang3BuilderHashCodeBuilder *builder = create_OrgApacheCommonsLang3BuilderHashCodeBuilder_initWithInt_withInt_(initialNonZeroOddNumber, multiplierNonZeroOddNumber);
...
void OrgApacheCommonsLang3BuilderHashCodeBuilder_register__WithId_(id value) {
  ...
  if (registry == nil) {
    ...
    [((JavaLangThreadLocal *) nil_chk(OrgApacheCommonsLang3BuilderHashCodeBuilder_REGISTRY)) setWithId:registry];
  }
  [registry addWithId:create_OrgApacheCommonsLang3BuilderIDKey_initWithId_(value)];
}
...
void OrgApacheCommonsLang3BuilderHashCodeBuilder_unregisterWithId_(id value) {
  ...
  id<JavaUtilSet> registry = OrgApacheCommonsLang3BuilderHashCodeBuilder_getRegistry();
  if (registry != nil) {
    [registry removeWithId:create_OrgApacheCommonsLang3BuilderIDKey_initWithId_(value)];
    if ([registry isEmpty]) {
...
void OrgApacheCommonsLang3BuilderHashCodeBuilder_initWithInt_withInt_(OrgApacheCommonsLang3BuilderHashCodeBuilder *self, jint initialOddNumber, jint multiplierOddNumber) {
  NSObject_init(self);
  self->iTotal_ = 0;
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(initialOddNumber % 2 != 0, @"HashCodeBuilder requires an odd initial value", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  OrgApacheCommonsLang3Validate_isTrueWithBoolean_withNSString_withNSObjectArray_(multiplierOddNumber % 2 != 0, @"HashCodeBuilder requires an odd multiplier", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
...
void OrgApacheCommonsLang3BuilderHashCodeBuilder_appendArrayWithId_(OrgApacheCommonsLang3BuilderHashCodeBuilder *self, id object) {
  if ([object isKindOfClass:[IOSLongArray class]]) {
    [self appendWithLongArray:(IOSLongArray *) cast_chk(object, [IOSLongArray class])];
  }
  else if ([object isKindOfClass:[IOSIntArray class]]) {
    [self appendWithIntArray:(IOSIntArray *) cast_chk(object, [IOSIntArray class])];
  }
  else if ([object isKindOfClass:[IOSShortArray class]]) {
    [self appendWithShortArray:(IOSShortArray *) cast_chk(object, [IOSShortArray class])];
  }
  else if ([object isKindOfClass:[IOSCharArray class]]) {
    [self appendWithCharArray:(IOSCharArray *) cast_chk(object, [IOSCharArray class])];
  }
  else if ([object isKindOfClass:[IOSByteArray class]]) {
    [self appendWithByteArray:(IOSByteArray *) cast_chk(object, [IOSByteArray class])];
  }
  else if ([object isKindOfClass:[IOSDoubleArray class]]) {
    [self appendWithDoubleArray:(IOSDoubleArray *) cast_chk(object, [IOSDoubleArray class])];
  }
  else if ([object isKindOfClass:[IOSFloatArray class]]) {
    [self appendWithFloatArray:(IOSFloatArray *) cast_chk(object, [IOSFloatArray class])];
  }
  else if ([object isKindOfClass:[IOSBooleanArray class]]) {
    [self appendWithBooleanArray:(IOSBooleanArray *) cast_chk(object, [IOSBooleanArray class])];
  }
  else {
    [self appendWithNSObjectArray:(IOSObjectArray *) cast_check(object, IOSClass_arrayType(NSObject_class_(), 1))];
  }
}
