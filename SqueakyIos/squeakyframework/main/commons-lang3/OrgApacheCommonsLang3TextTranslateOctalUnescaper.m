...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/text/translate/OctalUnescaper.java
//
...
- (jint)translateWithJavaLangCharSequence:(id<JavaLangCharSequence>)input
  ...
  jint remaining = [((id<JavaLangCharSequence>) nil_chk(input)) length] - index - 1;
