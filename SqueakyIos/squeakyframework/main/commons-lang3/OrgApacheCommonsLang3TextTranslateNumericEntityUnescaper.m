...
- (jint)translateWithJavaLangCharSequence:(id<JavaLangCharSequence>)input
  ...
  jint seqEnd = [((id<JavaLangCharSequence>) nil_chk(input)) length];
  if ([input charAtWithInt:index] == '&' && index < seqEnd - 2 && [input charAtWithInt:index + 1] == '#') {
    ...
    if (!semiNext) {
      if ([self isSetWithOrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION:JreLoadEnum(OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION, semiColonRequired)]) {
        ...
        @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Semi-colon required at end of numeric entity");
      }
    }
    jint entityValue;
    @try {
...
void OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_initWithOrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTIONArray_(OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper *self, IOSObjectArray *options) {
  ...
  if (((IOSObjectArray *) nil_chk(options))->size_ > 0) {
    JreStrongAssign(&self->options_, JavaUtilEnumSet_copyOfWithJavaUtilCollection_(JavaUtilArrays_asListWithNSObjectArray_(options)));
  }
  else {
    JreStrongAssign(&self->options_, JavaUtilEnumSet_copyOfWithJavaUtilCollection_(JavaUtilArrays_asListWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ JreLoadEnum(OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION, semiColonRequired) } count:1 type:OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION_class_()])));
  }
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION class]) {
    ...
    for (jint i = 0; i < 3; i++) {
      (OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      OrgApacheCommonsLang3TextTranslateNumericEntityUnescaper_OPTION_initWithNSString_withInt_(e, names[i], i);
    }
