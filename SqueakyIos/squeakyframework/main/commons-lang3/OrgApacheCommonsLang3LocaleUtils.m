...
//  source: /Users/kgalligan/devel-doppl/commons-lang/src/main/java/org/apache/commons/lang3/LocaleUtils.java
//

#include "IOSObjectArray.h"
#include "J2ObjC_source.h"
#include "OrgApacheCommonsLang3LocaleUtils.h"
...
inline id<JavaUtilConcurrentConcurrentMap> OrgApacheCommonsLang3LocaleUtils_get_cLanguagesByCountry();
...
inline id<JavaUtilConcurrentConcurrentMap> OrgApacheCommonsLang3LocaleUtils_get_cCountriesByLanguage();
...
inline id<JavaUtilList> OrgApacheCommonsLang3LocaleUtils_SyncAvoid_get_AVAILABLE_LOCALE_LIST();
...
inline id<JavaUtilSet> OrgApacheCommonsLang3LocaleUtils_SyncAvoid_get_AVAILABLE_LOCALE_SET();
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3LocaleUtils class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3LocaleUtils_cLanguagesByCountry, new_JavaUtilConcurrentConcurrentHashMap_init());
    JreStrongAssignAndConsume(&OrgApacheCommonsLang3LocaleUtils_cCountriesByLanguage, new_JavaUtilConcurrentConcurrentHashMap_init());
...
JavaUtilLocale *OrgApacheCommonsLang3LocaleUtils_toLocaleWithNSString_(NSString *str) {
  ...
  if ([str java_isEmpty]) {
    return create_JavaUtilLocale_initWithNSString_withNSString_(OrgApacheCommonsLang3StringUtils_EMPTY, OrgApacheCommonsLang3StringUtils_EMPTY);
  }
  if ([str java_contains:@"#"]) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Invalid locale format: ", str));
  }
  ...
  if (ch0 == '_') {
    ...
    if (len == 3) {
      return create_JavaUtilLocale_initWithNSString_withNSString_(OrgApacheCommonsLang3StringUtils_EMPTY, [str java_substring:1 endIndex:3]);
    }
    if (len < 5) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Invalid locale format: ", str));
    }
    ...
    return create_JavaUtilLocale_initWithNSString_withNSString_withNSString_(OrgApacheCommonsLang3StringUtils_EMPTY, [str java_substring:1 endIndex:3], [str java_substring:4]);
  }
  ...
  switch (occurrences) {
    ...
    if (OrgApacheCommonsLang3StringUtils_isAllLowerCaseWithJavaLangCharSequence_(str) && (len == 2 || len == 3)) {
      return create_JavaUtilLocale_initWithNSString_(str);
    }
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Invalid locale format: ", str));
    case 1:
    if (OrgApacheCommonsLang3StringUtils_isAllLowerCaseWithJavaLangCharSequence_(IOSObjectArray_Get(split, 0)) && (((jint) [((NSString *) nil_chk(IOSObjectArray_Get(split, 0))) length]) == 2 || ((jint) [((NSString *) nil_chk(IOSObjectArray_Get(split, 0))) length]) == 3) && ((jint) [((NSString *) nil_chk(IOSObjectArray_Get(split, 1))) length]) == 2 && OrgApacheCommonsLang3StringUtils_isAllUpperCaseWithJavaLangCharSequence_(IOSObjectArray_Get(split, 1))) {
      return create_JavaUtilLocale_initWithNSString_withNSString_(IOSObjectArray_Get(split, 0), IOSObjectArray_Get(split, 1));
    }
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Invalid locale format: ", str));
    case 2:
    if (OrgApacheCommonsLang3StringUtils_isAllLowerCaseWithJavaLangCharSequence_(IOSObjectArray_Get(split, 0)) && (((jint) [((NSString *) nil_chk(IOSObjectArray_Get(split, 0))) length]) == 2 || ((jint) [((NSString *) nil_chk(IOSObjectArray_Get(split, 0))) length]) == 3) && (((jint) [((NSString *) nil_chk(IOSObjectArray_Get(split, 1))) length]) == 0 || (((jint) [((NSString *) nil_chk(IOSObjectArray_Get(split, 1))) length]) == 2 && OrgApacheCommonsLang3StringUtils_isAllUpperCaseWithJavaLangCharSequence_(IOSObjectArray_Get(split, 1)))) && ((jint) [((NSString *) nil_chk(IOSObjectArray_Get(split, 2))) length]) > 0) {
...
id<JavaUtilList> OrgApacheCommonsLang3LocaleUtils_localeLookupListWithJavaUtilLocale_withJavaUtilLocale_(JavaUtilLocale *locale, JavaUtilLocale *defaultLocale) {
  OrgApacheCommonsLang3LocaleUtils_initialize();
  id<JavaUtilList> list = create_JavaUtilArrayList_initWithInt_(4);
  if (locale != nil) {
    [list addWithId:locale];
    if (((jint) [((NSString *) nil_chk([locale getVariant])) length]) > 0) {
      [list addWithId:create_JavaUtilLocale_initWithNSString_withNSString_([locale getLanguage], [locale getCountry])];
    }
    if (((jint) [((NSString *) nil_chk([locale getCountry])) length]) > 0) {
      [list addWithId:create_JavaUtilLocale_initWithNSString_withNSString_([locale getLanguage], OrgApacheCommonsLang3StringUtils_EMPTY)];
    }
...
id<JavaUtilList> OrgApacheCommonsLang3LocaleUtils_languagesByCountryWithNSString_(NSString *countryCode) {
  ...
  if (langs == nil) {
    langs = create_JavaUtilArrayList_init();
    ...
    [OrgApacheCommonsLang3LocaleUtils_cLanguagesByCountry putIfAbsentWithId:countryCode withId:langs];
...
id<JavaUtilList> OrgApacheCommonsLang3LocaleUtils_countriesByLanguageWithNSString_(NSString *languageCode) {
  ...
  if (countries == nil) {
    countries = create_JavaUtilArrayList_init();
    id<JavaUtilList> locales = OrgApacheCommonsLang3LocaleUtils_availableLocaleList();
    for (jint i = 0; i < [((id<JavaUtilList>) nil_chk(locales)) size]; i++) {
      JavaUtilLocale *locale = [locales getWithInt:i];
      if ([languageCode isEqual:[((JavaUtilLocale *) nil_chk(locale)) getLanguage]] && ((jint) [((NSString *) nil_chk([locale getCountry])) length]) != 0 && [((NSString *) nil_chk([locale getVariant])) java_isEmpty]) {
        [countries addWithId:locale];
      }
    }
    countries = JavaUtilCollections_unmodifiableListWithJavaUtilList_(countries);
    [OrgApacheCommonsLang3LocaleUtils_cCountriesByLanguage putIfAbsentWithId:languageCode withId:countries];
...
+ (void)initialize {
  if (self == [OrgApacheCommonsLang3LocaleUtils_SyncAvoid class]) {
    {
      id<JavaUtilList> list = create_JavaUtilArrayList_initWithJavaUtilCollection_(JavaUtilArrays_asListWithNSObjectArray_(JavaUtilLocale_getAvailableLocales()));
      JreStrongAssign(&OrgApacheCommonsLang3LocaleUtils_SyncAvoid_AVAILABLE_LOCALE_LIST, JavaUtilCollections_unmodifiableListWithJavaUtilList_(list));
      JreStrongAssign(&OrgApacheCommonsLang3LocaleUtils_SyncAvoid_AVAILABLE_LOCALE_SET, JavaUtilCollections_unmodifiableSetWithJavaUtilSet_(create_JavaUtilHashSet_initWithJavaUtilCollection_(list)));
    }
